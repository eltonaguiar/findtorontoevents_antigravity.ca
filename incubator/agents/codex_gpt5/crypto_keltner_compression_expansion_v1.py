"""
Crypto Keltner Compression Expansion - Baby Strat
"""
import numpy as np
import pandas as pd
...
if __name__ == '__main__':
    ...
    s = CryptoKeltnerCompressionExpansionStrategy()
    total = 0
