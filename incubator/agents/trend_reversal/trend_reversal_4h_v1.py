"""Trend Reversal Emoji — 4-hour timeframe baby strategy.

EMA(21/55/200) crossover + RSI(14) momentum + ATR(14) volatility gate.
Swing trading variant for longer holds.
...
class TrendReversalEmoji4hStrategy:
    """EMA crossover trend reversal — 4h timeframe (swing trading)."""
    ...
    def generate_signals(self, data: pd.DataFrame, symbol: str = "BTCUSDT") -> List[Signal]:
        ...
        return [Signal(
            ...
            stop_loss=sl,
            reason=(
                f"EMA(21)x EMA(55) {direction} [4h] | "
...
if __name__ == "__main__":
    ...
    strat = TrendReversalEmoji4hStrategy()
