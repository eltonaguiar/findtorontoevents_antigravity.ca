"""Trend Reversal Emoji — 5-minute timeframe baby strategy.

EMA(21/55/200) crossover + RSI(14) momentum + ATR(14) volatility gate.
Matches Pine Script by FundedRelay. High-frequency variant, capped at 3 picks.
...
class TrendReversalEmoji5mStrategy:
    """EMA crossover trend reversal — 5m timeframe."""
    ...
    def generate_signals(self, data: pd.DataFrame, symbol: str = "BTCUSDT") -> List[Signal]:
        ...
        return [Signal(
            ...
            stop_loss=sl,
            reason=(
                f"EMA(21)x EMA(55) {direction} [5m] | "
...
if __name__ == "__main__":
    ...
    strat = TrendReversalEmoji5mStrategy()
