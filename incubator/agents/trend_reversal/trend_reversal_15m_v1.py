"""Trend Reversal Emoji — 15-minute timeframe baby strategy.

EMA(21/55/200) crossover + RSI(14) momentum + ATR(14) volatility gate.
Optimal timeframe per Hsu & Kuan (2005) research.
...
class TrendReversalEmoji15mStrategy:
    """EMA crossover trend reversal — 15m timeframe (research-optimal)."""
    ...
    def generate_signals(self, data: pd.DataFrame, symbol: str = "BTCUSDT") -> List[Signal]:
        ...
        return [Signal(
            ...
            stop_loss=sl,
            reason=(
                f"EMA(21)x EMA(55) {direction} [15m] | "
...
if __name__ == "__main__":
    ...
    strat = TrendReversalEmoji15mStrategy()
