"""
EMA Death Cross Short — LOOSE MUTATION
========================================
DNA Mutation B: Looser entry (more signals)
- ADX threshold: 20 -> 16 (-20%)
...
class EMADeathCrossShortLooseStrategy:
    """Loose mutation: ADX threshold 20 -> 16."""
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.adx_threshold = self.params.get('adx_threshold', 16)  # MUTATED: 20 -> 16
        ...
        for i in range(min_len, len(data)):
            ...
            if cross_down and cur_adx > self.adx_threshold:
                ...
                signals.append(Signal(
                    ...
                    reason=f"DEATH_CROSS_LOOSE EMA9<EMA21 ADX={cur_adx:.1f}"
                ))
                last_signal_bar = i
