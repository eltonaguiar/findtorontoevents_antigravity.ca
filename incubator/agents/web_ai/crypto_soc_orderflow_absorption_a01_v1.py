"""
crypto_soc_orderflow_absorption_a01_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc003OrderflowAbsorptionStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.1608)
        self.meanrev_w = self.p.get('meanrev_w', 0.1224)
        self.breakout_w = self.p.get('breakout_w', 0.1131)
        self.volstate_w = self.p.get('volstate_w', 0.1312)
        self.flow_w = self.p.get('flow_w', 0.3849)
        self.session_w = self.p.get('session_w', 0.0877)

        self.long_threshold = self.p.get('long_threshold', 0.390)
        self.short_threshold = self.p.get('short_threshold', 0.390)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc003OrderflowAbsorptionStrategy()
    total = 0
