"""
crypto_soc_proxy_decoupling_a05_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc049ProxyDecouplingStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2962)
        self.meanrev_w = self.p.get('meanrev_w', 0.0823)
        self.breakout_w = self.p.get('breakout_w', 0.1215)
        self.volstate_w = self.p.get('volstate_w', 0.2194)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc049ProxyDecouplingStrategy()
    total = 0
