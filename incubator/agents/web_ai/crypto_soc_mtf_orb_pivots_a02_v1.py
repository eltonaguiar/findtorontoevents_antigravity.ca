"""
crypto_soc_mtf_orb_pivots_a02_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc016MtfOrbPivotsStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2521)
        self.meanrev_w = self.p.get('meanrev_w', 0.1173)
        self.breakout_w = self.p.get('breakout_w', 0.2953)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc016MtfOrbPivotsStrategy()
    total = 0
