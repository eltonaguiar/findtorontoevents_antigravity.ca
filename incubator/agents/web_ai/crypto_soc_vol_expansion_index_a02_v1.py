"""
crypto_soc_vol_expansion_index_a02_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc012VolExpansionIndexStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.breakout_w = self.p.get('breakout_w', 0.1924)
        self.volstate_w = self.p.get('volstate_w', 0.2978)
        self.flow_w = self.p.get('flow_w', 0.0957)
        self.session_w = self.p.get('session_w', 0.0653)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc012VolExpansionIndexStrategy()
    total = 0
