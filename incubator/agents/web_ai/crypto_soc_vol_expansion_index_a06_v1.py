"""
crypto_soc_vol_expansion_index_a06_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc052VolExpansionIndexStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.breakout_w = self.p.get('breakout_w', 0.1783)
        self.volstate_w = self.p.get('volstate_w', 0.3003)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc052VolExpansionIndexStrategy()
    total = 0
