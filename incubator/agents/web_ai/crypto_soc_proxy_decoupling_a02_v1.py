"""
crypto_soc_proxy_decoupling_a02_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc019ProxyDecouplingStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2726)
        self.meanrev_w = self.p.get('meanrev_w', 0.0967)
        self.breakout_w = self.p.get('breakout_w', 0.1307)
        self.volstate_w = self.p.get('volstate_w', 0.2155)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc019ProxyDecouplingStrategy()
    total = 0
