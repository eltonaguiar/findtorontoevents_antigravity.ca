"""
crypto_soc_vol_expansion_index_a03_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc022VolExpansionIndexStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.breakout_w = self.p.get('breakout_w', 0.1888)
        self.volstate_w = self.p.get('volstate_w', 0.2985)
        self.flow_w = self.p.get('flow_w', 0.0969)
        self.session_w = self.p.get('session_w', 0.0638)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc022VolExpansionIndexStrategy()
    total = 0
