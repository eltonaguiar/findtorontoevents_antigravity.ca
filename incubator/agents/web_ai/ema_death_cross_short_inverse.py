"""
EMA Death Cross Short — INVERSE MUTATION
==========================================
DNA Mutation C: Flip direction (golden cross long)
- Original: SHORT on EMA(9) < EMA(21) death cross
- Inverse: LONG on EMA(9) > EMA(21) golden cross
...
class EMADeathCrossShortInverseStrategy:
    """Inverse mutation: LONG on golden cross (EMA9 > EMA21) + ADX > 20."""
    ...
    def generate_signals(self, data: pd.DataFrame, symbol: str = "BTCUSDT") -> List[Signal]:
        ...
        for i in range(min_len, len(data)):
            ...
            # INVERSE: golden cross (EMA9 crosses ABOVE EMA21)
            cross_up = prev_ema_fast <= prev_ema_slow and cur_ema_fast > cur_ema_slow

            if cross_up and cur_adx > self.adx_threshold:
                ...
                signals.append(Signal(
                    ...
                    reason=f"GOLDEN_CROSS_INV EMA9>EMA21 ADX={cur_adx:.1f}"
                ))
                last_signal_bar = i
