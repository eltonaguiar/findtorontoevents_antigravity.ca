"""
crypto_soc_intraday_time_slices_a01_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc005IntradayTimeSlicesStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2023)
        self.meanrev_w = self.p.get('meanrev_w', 0.1432)
        self.breakout_w = self.p.get('breakout_w', 0.1753)
        self.volstate_w = self.p.get('volstate_w', 0.1105)
        self.flow_w = self.p.get('flow_w', 0.1151)
        self.session_w = self.p.get('session_w', 0.2536)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc005IntradayTimeSlicesStrategy()
    total = 0
