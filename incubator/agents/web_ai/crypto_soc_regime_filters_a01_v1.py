"""
crypto_soc_regime_filters_a01_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc001RegimeFiltersStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.3060)
        self.meanrev_w = self.p.get('meanrev_w', 0.1432)
        self.breakout_w = self.p.get('breakout_w', 0.1546)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc001RegimeFiltersStrategy()
    total = 0
