"""
crypto_soc_vol_expansion_index_a04_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc032VolExpansionIndexStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.breakout_w = self.p.get('breakout_w', 0.1852)
        self.volstate_w = self.p.get('volstate_w', 0.2991)
        self.flow_w = self.p.get('flow_w', 0.0982)
        self.session_w = self.p.get('session_w', 0.0622)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc032VolExpansionIndexStrategy()
    total = 0
