"""
crypto_soc_regime_filters_a08_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc071RegimeFiltersStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.3578)
        self.meanrev_w = self.p.get('meanrev_w', 0.1078)
        self.breakout_w = self.p.get('breakout_w', 0.1324)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc071RegimeFiltersStrategy()
    total = 0
