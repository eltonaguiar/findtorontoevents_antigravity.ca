"""
crypto_soc_proxy_decoupling_a06_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc059ProxyDecouplingStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.3038)
        self.meanrev_w = self.p.get('meanrev_w', 0.0777)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc059ProxyDecouplingStrategy()
    total = 0
