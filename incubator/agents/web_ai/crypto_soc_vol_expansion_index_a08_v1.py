"""
crypto_soc_vol_expansion_index_a08_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc072VolExpansionIndexStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.meanrev_w = self.p.get('meanrev_w', 0.0882)
        self.breakout_w = self.p.get('breakout_w', 0.1716)
        self.volstate_w = self.p.get('volstate_w', 0.3015)
        self.flow_w = self.p.get('flow_w', 0.1029)
        self.session_w = self.p.get('session_w', 0.0564)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc072VolExpansionIndexStrategy()
    total = 0
