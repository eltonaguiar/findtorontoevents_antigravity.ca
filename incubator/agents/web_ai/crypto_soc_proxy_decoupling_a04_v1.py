"""
crypto_soc_proxy_decoupling_a04_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc039ProxyDecouplingStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2885)
        self.meanrev_w = self.p.get('meanrev_w', 0.0870)
        self.breakout_w = self.p.get('breakout_w', 0.1245)
        self.volstate_w = self.p.get('volstate_w', 0.2181)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc039ProxyDecouplingStrategy()
    total = 0
