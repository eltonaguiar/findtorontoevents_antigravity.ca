"""
crypto_soc_orderflow_absorption_a05_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc043OrderflowAbsorptionStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.1958)
        self.meanrev_w = self.p.get('meanrev_w', 0.1024)
        self.breakout_w = self.p.get('breakout_w', 0.1014)
        self.volstate_w = self.p.get('volstate_w', 0.1391)
        self.flow_w = self.p.get('flow_w', 0.3805)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc043OrderflowAbsorptionStrategy()
    total = 0
