"""
crypto_soc_proxy_decoupling_a09_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc089ProxyDecouplingStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.3259)
        self.meanrev_w = self.p.get('meanrev_w', 0.0642)
        self.breakout_w = self.p.get('breakout_w', 0.1099)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc089ProxyDecouplingStrategy()
    total = 0
