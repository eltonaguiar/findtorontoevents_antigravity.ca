"""
crypto_soc_micro_noise_filter_a04_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc038MicroNoiseFilterStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.breakout_w = self.p.get('breakout_w', 0.1245)
        self.volstate_w = self.p.get('volstate_w', 0.2788)
        self.flow_w = self.p.get('flow_w', 0.1791)
        self.session_w = self.p.get('session_w', 0.1027)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc038MicroNoiseFilterStrategy()
    total = 0
