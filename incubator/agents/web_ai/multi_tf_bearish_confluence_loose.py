"""
Multi-Timeframe Bearish Confluence — LOOSE MUTATION
=====================================================
DNA Mutation B: Looser entry (more signals)
- RSI overbought threshold: 60 -> 51 (-15%)
...
class MultiTFBearishConfluenceLooseStrategy:
    """Loose mutation: RSI overbought 60 -> 51."""
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.rsi_ob = self.params.get('rsi_overbought', 51)  # MUTATED: 60 -> 51
        ...
        for i in range(min_len, len(data)):
            ...
            if trend_down and rsi_ob and atr_expanding:
                ...
                signals.append(Signal(
                    ...
                    reason=f"MTF_BEAR_LOOSE EMA8<21 RSI={cur_rsi:.1f} ATR_exp={cur_atr/cur_atr_sma:.2f}"
                ))
                last_signal_bar = i
