"""
crypto_soc_trend_filtered_meanrev_a02_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc017TrendFilteredMeanrevStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2315)
        self.meanrev_w = self.p.get('meanrev_w', 0.3642)
        self.breakout_w = self.p.get('breakout_w', 0.0895)
        self.volstate_w = self.p.get('volstate_w', 0.1332)
        self.flow_w = self.p.get('flow_w', 0.0957)
        self.session_w = self.p.get('session_w', 0.0859)

        self.long_threshold = self.p.get('long_threshold', 0.380)
        self.short_threshold = self.p.get('short_threshold', 0.380)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc017TrendFilteredMeanrevStrategy()
    total = 0
