"""
crypto_soc_regime_filters_a07_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc061RegimeFiltersStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.3508)
        self.meanrev_w = self.p.get('meanrev_w', 0.1126)
        self.breakout_w = self.p.get('breakout_w', 0.1354)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc061RegimeFiltersStrategy()
    total = 0
