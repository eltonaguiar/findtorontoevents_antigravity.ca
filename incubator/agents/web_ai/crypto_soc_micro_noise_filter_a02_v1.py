"""
crypto_soc_micro_noise_filter_a02_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc018MicroNoiseFilterStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.breakout_w = self.p.get('breakout_w', 0.1307)
        self.volstate_w = self.p.get('volstate_w', 0.2773)
        self.flow_w = self.p.get('flow_w', 0.1780)
        self.session_w = self.p.get('session_w', 0.1065)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc018MicroNoiseFilterStrategy()
    total = 0
