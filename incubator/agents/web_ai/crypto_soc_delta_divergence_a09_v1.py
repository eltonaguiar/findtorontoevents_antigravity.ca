"""
crypto_soc_delta_divergence_a09_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc084DeltaDivergenceStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2481)
        self.meanrev_w = self.p.get('meanrev_w', 0.1615)
        self.breakout_w = self.p.get('breakout_w', 0.0905)
        self.volstate_w = self.p.get('volstate_w', 0.1464)
        self.flow_w = self.p.get('flow_w', 0.2986)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc084DeltaDivergenceStrategy()
    total = 0
