"""
crypto_soc_regime_filters_a06_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc051RegimeFiltersStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.3436)
        self.meanrev_w = self.p.get('meanrev_w', 0.1175)
        self.breakout_w = self.p.get('breakout_w', 0.1384)
        self.volstate_w = self.p.get('volstate_w', 0.2206)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc051RegimeFiltersStrategy()
    total = 0
