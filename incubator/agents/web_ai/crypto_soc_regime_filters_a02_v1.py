"""
crypto_soc_regime_filters_a02_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc011RegimeFiltersStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.3138)
        self.meanrev_w = self.p.get('meanrev_w', 0.1379)
        self.breakout_w = self.p.get('breakout_w', 0.1512)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc011RegimeFiltersStrategy()
    total = 0
