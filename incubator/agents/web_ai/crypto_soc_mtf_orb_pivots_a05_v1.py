"""
crypto_soc_mtf_orb_pivots_a05_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc046MtfOrbPivotsStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2761)
        self.meanrev_w = self.p.get('meanrev_w', 0.1024)
        self.breakout_w = self.p.get('breakout_w', 0.2821)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc046MtfOrbPivotsStrategy()
    total = 0
