"""
crypto_soc_mtf_orb_pivots_a01_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc006MtfOrbPivotsStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2438)
        self.meanrev_w = self.p.get('meanrev_w', 0.1224)
        self.breakout_w = self.p.get('breakout_w', 0.2998)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc006MtfOrbPivotsStrategy()
    total = 0
