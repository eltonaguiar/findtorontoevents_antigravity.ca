"""
crypto_soc_delta_divergence_a05_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc044DeltaDivergenceStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2159)
        self.meanrev_w = self.p.get('meanrev_w', 0.1827)
        self.breakout_w = self.p.get('breakout_w', 0.1014)
        self.volstate_w = self.p.get('volstate_w', 0.1391)
        self.flow_w = self.p.get('flow_w', 0.3002)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc044DeltaDivergenceStrategy()
    total = 0
