"""
crypto_soc_micro_noise_filter_a05_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc048MicroNoiseFilterStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.breakout_w = self.p.get('breakout_w', 0.1215)
        self.volstate_w = self.p.get('volstate_w', 0.2796)
        self.flow_w = self.p.get('flow_w', 0.1797)
        self.session_w = self.p.get('session_w', 0.1009)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc048MicroNoiseFilterStrategy()
    total = 0
