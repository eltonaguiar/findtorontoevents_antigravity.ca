"""
crypto_soc_proxy_decoupling_a08_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc079ProxyDecouplingStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.3186)
        self.meanrev_w = self.p.get('meanrev_w', 0.0686)
        self.breakout_w = self.p.get('breakout_w', 0.1127)
        self.volstate_w = self.p.get('volstate_w', 0.2230)
        self.flow_w = self.p.get('flow_w', 0.1814)
        self.session_w = self.p.get('session_w', 0.0956)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc079ProxyDecouplingStrategy()
    total = 0
