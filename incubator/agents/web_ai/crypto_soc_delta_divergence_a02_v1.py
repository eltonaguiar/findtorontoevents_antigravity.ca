"""
crypto_soc_delta_divergence_a02_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc014DeltaDivergenceStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.1903)
        self.meanrev_w = self.p.get('meanrev_w', 0.1996)
        self.breakout_w = self.p.get('breakout_w', 0.1101)
        self.volstate_w = self.p.get('volstate_w', 0.1332)
        self.flow_w = self.p.get('flow_w', 0.3014)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc014DeltaDivergenceStrategy()
    total = 0
