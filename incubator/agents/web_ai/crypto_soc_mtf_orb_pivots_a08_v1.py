"""
crypto_soc_mtf_orb_pivots_a08_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc076MtfOrbPivotsStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2990)
        self.meanrev_w = self.p.get('meanrev_w', 0.0882)
        self.breakout_w = self.p.get('breakout_w', 0.2696)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc076MtfOrbPivotsStrategy()
    total = 0
