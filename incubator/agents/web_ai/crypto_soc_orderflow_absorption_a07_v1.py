"""
crypto_soc_orderflow_absorption_a07_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc063OrderflowAbsorptionStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2125)
        self.meanrev_w = self.p.get('meanrev_w', 0.0929)
        self.breakout_w = self.p.get('breakout_w', 0.0958)
        self.volstate_w = self.p.get('volstate_w', 0.1428)
        self.flow_w = self.p.get('flow_w', 0.3785)
        self.session_w = self.p.get('session_w', 0.0776)

        self.long_threshold = self.p.get('long_threshold', 0.450)
        self.short_threshold = self.p.get('short_threshold', 0.450)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc063OrderflowAbsorptionStrategy()
    total = 0
