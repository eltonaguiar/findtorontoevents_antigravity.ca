"""
crypto_soc_intraday_time_slices_a04_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc035IntradayTimeSlicesStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2277)
        self.meanrev_w = self.p.get('meanrev_w', 0.1275)
        self.breakout_w = self.p.get('breakout_w', 0.1650)
        self.volstate_w = self.p.get('volstate_w', 0.1169)
        self.flow_w = self.p.get('flow_w', 0.1184)
        self.session_w = self.p.get('session_w', 0.2444)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc035IntradayTimeSlicesStrategy()
    total = 0
