"""
Multi-Timeframe Bearish Confluence — TIGHT MUTATION
=====================================================
DNA Mutation A: Tighter TP/SL (R:R 1.0-1.5 optimal)
- TP: 2.0 -> 1.4 ATR (-30%)
- SL: 1.0 -> 0.8 ATR (-20%)
...
class MultiTFBearishConfluenceTightStrategy:
    """Tight mutation: TP=1.4x ATR, SL=0.8x ATR."""
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.tp_atr = self.params.get('tp_atr', 1.4)   # MUTATED: 2.0 -> 1.4
        self.sl_atr = self.params.get('sl_atr', 0.8)    # MUTATED: 1.0 -> 0.8
        ...
        for i in range(min_len, len(data)):
            ...
            if trend_down and rsi_ob and atr_expanding:
                ...
                signals.append(Signal(
                    ...
                    reason=f"MTF_BEAR_TIGHT EMA8<21 RSI={cur_rsi:.1f} ATR_exp={cur_atr/cur_atr_sma:.2f}"
                ))
                last_signal_bar = i
