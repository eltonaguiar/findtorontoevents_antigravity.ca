"""
crypto_soc_trend_filtered_meanrev_a09_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc087TrendFilteredMeanrevStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2870)
        self.meanrev_w = self.p.get('meanrev_w', 0.3171)
        self.breakout_w = self.p.get('breakout_w', 0.0710)
        self.volstate_w = self.p.get('volstate_w', 0.1464)
        self.flow_w = self.p.get('flow_w', 0.1041)
        self.session_w = self.p.get('session_w', 0.0744)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc087TrendFilteredMeanrevStrategy()
    total = 0
