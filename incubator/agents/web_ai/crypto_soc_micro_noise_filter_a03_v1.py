"""
crypto_soc_micro_noise_filter_a03_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc028MicroNoiseFilterStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.breakout_w = self.p.get('breakout_w', 0.1276)
        self.volstate_w = self.p.get('volstate_w', 0.2781)
        self.flow_w = self.p.get('flow_w', 0.1786)
        self.session_w = self.p.get('session_w', 0.1046)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc028MicroNoiseFilterStrategy()
    total = 0
