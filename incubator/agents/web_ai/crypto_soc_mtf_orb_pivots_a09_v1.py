"""
crypto_soc_mtf_orb_pivots_a09_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc086MtfOrbPivotsStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.3064)
        self.meanrev_w = self.p.get('meanrev_w', 0.0837)
        self.breakout_w = self.p.get('breakout_w', 0.2656)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc086MtfOrbPivotsStrategy()
    total = 0
