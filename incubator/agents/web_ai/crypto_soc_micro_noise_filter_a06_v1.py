"""
crypto_soc_micro_noise_filter_a06_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc058MicroNoiseFilterStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.breakout_w = self.p.get('breakout_w', 0.1185)
        self.volstate_w = self.p.get('volstate_w', 0.2804)
        self.flow_w = self.p.get('flow_w', 0.1803)
        self.session_w = self.p.get('session_w', 0.0991)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc058MicroNoiseFilterStrategy()
    total = 0
