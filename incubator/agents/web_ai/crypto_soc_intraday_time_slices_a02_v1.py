"""
crypto_soc_intraday_time_slices_a02_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc015IntradayTimeSlicesStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2109)
        self.meanrev_w = self.p.get('meanrev_w', 0.1379)
        self.breakout_w = self.p.get('breakout_w', 0.1718)
        self.volstate_w = self.p.get('volstate_w', 0.1127)
        self.flow_w = self.p.get('flow_w', 0.1163)
        self.session_w = self.p.get('session_w', 0.2505)

        self.long_threshold = self.p.get('long_threshold', 0.410)
        self.short_threshold = self.p.get('short_threshold', 0.410)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc015IntradayTimeSlicesStrategy()
    total = 0
