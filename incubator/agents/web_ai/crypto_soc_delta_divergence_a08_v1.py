"""
crypto_soc_delta_divergence_a08_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc074DeltaDivergenceStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2402)
        self.meanrev_w = self.p.get('meanrev_w', 0.1667)
        self.breakout_w = self.p.get('breakout_w', 0.0931)
        self.volstate_w = self.p.get('volstate_w', 0.1446)
        self.flow_w = self.p.get('flow_w', 0.2990)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc074DeltaDivergenceStrategy()
    total = 0
