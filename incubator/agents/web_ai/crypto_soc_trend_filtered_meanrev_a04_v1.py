"""
crypto_soc_trend_filtered_meanrev_a04_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc037TrendFilteredMeanrevStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2480)
        self.meanrev_w = self.p.get('meanrev_w', 0.3502)
        self.breakout_w = self.p.get('breakout_w', 0.0840)
        self.volstate_w = self.p.get('volstate_w', 0.1371)
        self.flow_w = self.p.get('flow_w', 0.0982)
        self.session_w = self.p.get('session_w', 0.0825)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc037TrendFilteredMeanrevStrategy()
    total = 0
