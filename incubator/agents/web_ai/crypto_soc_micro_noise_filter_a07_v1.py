"""
crypto_soc_micro_noise_filter_a07_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc068MicroNoiseFilterStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.meanrev_w = self.p.get('meanrev_w', 0.1126)
        self.breakout_w = self.p.get('breakout_w', 0.1156)
        self.volstate_w = self.p.get('volstate_w', 0.2811)
        self.flow_w = self.p.get('flow_w', 0.1808)
        self.session_w = self.p.get('session_w', 0.0973)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc068MicroNoiseFilterStrategy()
    total = 0
