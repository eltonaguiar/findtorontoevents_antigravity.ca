"""
crypto_soc_mtf_orb_pivots_a03_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc026MtfOrbPivotsStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2602)
        self.meanrev_w = self.p.get('meanrev_w', 0.1122)
        self.breakout_w = self.p.get('breakout_w', 0.2908)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc026MtfOrbPivotsStrategy()
    total = 0
