"""
crypto_soc_delta_divergence_a03_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc024DeltaDivergenceStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.1990)
        self.meanrev_w = self.p.get('meanrev_w', 0.1939)
        self.breakout_w = self.p.get('breakout_w', 0.1071)
        self.volstate_w = self.p.get('volstate_w', 0.1352)
        self.flow_w = self.p.get('flow_w', 0.3010)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc024DeltaDivergenceStrategy()
    total = 0
