"""
crypto_soc_proxy_decoupling_a10_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc099ProxyDecouplingStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.3330)
        self.meanrev_w = self.p.get('meanrev_w', 0.0598)
        self.breakout_w = self.p.get('breakout_w', 0.1071)
        self.volstate_w = self.p.get('volstate_w', 0.2254)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc099ProxyDecouplingStrategy()
    total = 0
