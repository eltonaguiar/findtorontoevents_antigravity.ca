"""
crypto_soc_regime_filters_a05_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc041RegimeFiltersStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.3363)
        self.meanrev_w = self.p.get('meanrev_w', 0.1225)
        self.breakout_w = self.p.get('breakout_w', 0.1416)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc041RegimeFiltersStrategy()
    total = 0
