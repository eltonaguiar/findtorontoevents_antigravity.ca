"""
crypto_soc_intraday_time_slices_a09_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc085IntradayTimeSlicesStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.volstate_w = self.p.get('volstate_w', 0.1269)
        self.flow_w = self.p.get('flow_w', 0.1235)
        self.session_w = self.p.get('session_w', 0.2301)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc085IntradayTimeSlicesStrategy()
    total = 0
