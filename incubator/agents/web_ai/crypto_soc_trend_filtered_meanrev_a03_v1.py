"""
crypto_soc_trend_filtered_meanrev_a03_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc027TrendFilteredMeanrevStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2398)
        self.meanrev_w = self.p.get('meanrev_w', 0.3571)
        self.breakout_w = self.p.get('breakout_w', 0.0867)
        self.volstate_w = self.p.get('volstate_w', 0.1352)
        self.flow_w = self.p.get('flow_w', 0.0969)
        self.session_w = self.p.get('session_w', 0.0842)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc027TrendFilteredMeanrevStrategy()
    total = 0
