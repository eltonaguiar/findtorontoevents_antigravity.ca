"""
crypto_soc_intraday_time_slices_a03_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc025IntradayTimeSlicesStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2194)
        self.meanrev_w = self.p.get('meanrev_w', 0.1327)
        self.breakout_w = self.p.get('breakout_w', 0.1684)
        self.volstate_w = self.p.get('volstate_w', 0.1148)
        self.flow_w = self.p.get('flow_w', 0.1173)
        self.session_w = self.p.get('session_w', 0.2474)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc025IntradayTimeSlicesStrategy()
    total = 0
