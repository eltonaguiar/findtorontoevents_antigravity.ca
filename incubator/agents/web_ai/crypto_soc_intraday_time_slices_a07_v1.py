"""
crypto_soc_intraday_time_slices_a07_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc065IntradayTimeSlicesStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2520)
        self.meanrev_w = self.p.get('meanrev_w', 0.1126)
        self.breakout_w = self.p.get('breakout_w', 0.1551)
        self.volstate_w = self.p.get('volstate_w', 0.1230)
        self.flow_w = self.p.get('flow_w', 0.1215)
        self.session_w = self.p.get('session_w', 0.2357)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc065IntradayTimeSlicesStrategy()
    total = 0
