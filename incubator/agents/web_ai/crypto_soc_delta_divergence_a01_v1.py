"""
crypto_soc_delta_divergence_a01_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc004DeltaDivergenceStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.1815)
        self.meanrev_w = self.p.get('meanrev_w', 0.2054)
        self.breakout_w = self.p.get('breakout_w', 0.1131)
        self.volstate_w = self.p.get('volstate_w', 0.1312)
        self.flow_w = self.p.get('flow_w', 0.3019)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc004DeltaDivergenceStrategy()
    total = 0
