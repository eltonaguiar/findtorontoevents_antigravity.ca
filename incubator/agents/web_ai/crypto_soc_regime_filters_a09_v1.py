"""
crypto_soc_regime_filters_a09_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc081RegimeFiltersStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.3648)
        self.meanrev_w = self.p.get('meanrev_w', 0.1031)
        self.breakout_w = self.p.get('breakout_w', 0.1294)
        self.volstate_w = self.p.get('volstate_w', 0.2242)
        self.flow_w = self.p.get('flow_w', 0.1235)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc081RegimeFiltersStrategy()
    total = 0
