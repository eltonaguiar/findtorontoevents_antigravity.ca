"""
MultiPeriodRSIConfluence SOL - Baby Strat
"""
import numpy as np
import pandas as pd
...
class MultiPeriodRSIConfluenceSOLStrategy:
    """Short + long RSI alignment for SOL."""
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.rsi_short_th = self.params.get("rsi_short_th", 32)
        self.rsi_long_th = self.params.get("rsi_long_th", 37)
        self.atr_period = self.params.get("atr_period", 14)
        # R:R widened 2026-03-16: was 2.5, now 3.0 (target R:R >= 2.0; was 1.92, now 2.31)
