"""
crypto_soc_regime_filters_a03_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc021RegimeFiltersStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.3214)
        self.meanrev_w = self.p.get('meanrev_w', 0.1327)
        self.breakout_w = self.p.get('breakout_w', 0.1480)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc021RegimeFiltersStrategy()
    total = 0
