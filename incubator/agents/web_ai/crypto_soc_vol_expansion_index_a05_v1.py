"""
crypto_soc_vol_expansion_index_a05_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc042VolExpansionIndexStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.breakout_w = self.p.get('breakout_w', 0.1817)
        self.volstate_w = self.p.get('volstate_w', 0.2997)
        self.flow_w = self.p.get('flow_w', 0.0994)
        self.session_w = self.p.get('session_w', 0.0607)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc042VolExpansionIndexStrategy()
    total = 0
