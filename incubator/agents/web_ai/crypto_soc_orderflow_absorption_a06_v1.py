"""
crypto_soc_orderflow_absorption_a06_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc053OrderflowAbsorptionStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2042)
        self.meanrev_w = self.p.get('meanrev_w', 0.0976)
        self.breakout_w = self.p.get('breakout_w', 0.0986)
        self.volstate_w = self.p.get('volstate_w', 0.1409)
        self.flow_w = self.p.get('flow_w', 0.3795)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc053OrderflowAbsorptionStrategy()
    total = 0
