"""
crypto_soc_proxy_decoupling_a03_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc029ProxyDecouplingStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2806)
        self.meanrev_w = self.p.get('meanrev_w', 0.0918)
        self.breakout_w = self.p.get('breakout_w', 0.1276)
        self.volstate_w = self.p.get('volstate_w', 0.2168)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc029ProxyDecouplingStrategy()
    total = 0
