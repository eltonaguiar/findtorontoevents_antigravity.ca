"""
crypto_soc_dynamic_risk_heat_a05_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc050DynamicRiskHeatStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.volstate_w = self.p.get('volstate_w', 0.1993)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc050DynamicRiskHeatStrategy()
    total = 0
