"""
crypto_soc_orderflow_absorption_a08_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc073OrderflowAbsorptionStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2206)
        ...
        self.flow_w = self.p.get('flow_w', 0.3775)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc073OrderflowAbsorptionStrategy()
    total = 0
