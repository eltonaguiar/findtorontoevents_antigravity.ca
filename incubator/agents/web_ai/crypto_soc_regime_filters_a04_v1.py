"""
crypto_soc_regime_filters_a04_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc031RegimeFiltersStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.3289)
        self.meanrev_w = self.p.get('meanrev_w', 0.1275)
        self.breakout_w = self.p.get('breakout_w', 0.1447)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc031RegimeFiltersStrategy()
    total = 0
