"""
crypto_soc_micro_noise_filter_a09_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc088MicroNoiseFilterStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.volstate_w = self.p.get('volstate_w', 0.2826)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc088MicroNoiseFilterStrategy()
    total = 0
