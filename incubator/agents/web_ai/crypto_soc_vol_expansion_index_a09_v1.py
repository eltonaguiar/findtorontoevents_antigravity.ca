"""
crypto_soc_vol_expansion_index_a09_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc082VolExpansionIndexStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.breakout_w = self.p.get('breakout_w', 0.1683)
        self.volstate_w = self.p.get('volstate_w', 0.3020)
        self.flow_w = self.p.get('flow_w', 0.1041)
        self.session_w = self.p.get('session_w', 0.0550)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc082VolExpansionIndexStrategy()
    total = 0
