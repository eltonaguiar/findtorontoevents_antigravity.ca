"""
crypto_soc_micro_noise_filter_a01_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc008MicroNoiseFilterStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.breakout_w = self.p.get('breakout_w', 0.1338)
        self.volstate_w = self.p.get('volstate_w', 0.2765)
        self.flow_w = self.p.get('flow_w', 0.1774)
        self.session_w = self.p.get('session_w', 0.1084)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc008MicroNoiseFilterStrategy()
    total = 0
