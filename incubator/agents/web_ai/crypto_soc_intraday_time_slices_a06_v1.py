"""
crypto_soc_intraday_time_slices_a06_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc055IntradayTimeSlicesStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2440)
        self.meanrev_w = self.p.get('meanrev_w', 0.1175)
        self.breakout_w = self.p.get('breakout_w', 0.1584)
        self.volstate_w = self.p.get('volstate_w', 0.1210)
        self.flow_w = self.p.get('flow_w', 0.1205)
        self.session_w = self.p.get('session_w', 0.2385)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc055IntradayTimeSlicesStrategy()
    total = 0
