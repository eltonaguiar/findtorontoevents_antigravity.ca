"""
crypto_soc_delta_divergence_a06_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc054DeltaDivergenceStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2241)
        self.meanrev_w = self.p.get('meanrev_w', 0.1773)
        self.breakout_w = self.p.get('breakout_w', 0.0986)
        self.volstate_w = self.p.get('volstate_w', 0.1409)
        self.flow_w = self.p.get('flow_w', 0.2998)
        self.session_w = self.p.get('session_w', 0.0593)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc054DeltaDivergenceStrategy()
    total = 0
