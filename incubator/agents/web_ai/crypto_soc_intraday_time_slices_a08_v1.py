"""
crypto_soc_intraday_time_slices_a08_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc075IntradayTimeSlicesStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2598)
        self.meanrev_w = self.p.get('meanrev_w', 0.1078)
        self.breakout_w = self.p.get('breakout_w', 0.1520)
        self.volstate_w = self.p.get('volstate_w', 0.1250)
        self.flow_w = self.p.get('flow_w', 0.1225)
        self.session_w = self.p.get('session_w', 0.2328)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc075IntradayTimeSlicesStrategy()
    total = 0
