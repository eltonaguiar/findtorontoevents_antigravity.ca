"""
MultiPeriodRSIConfluence XRP - Baby Strat
"""
import numpy as np
import pandas as pd
...
class MultiPeriodRSIConfluenceXRPStrategy:
    """Short + long RSI alignment for XRP."""
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        # R:R widened 2026-03-16: was 2.3, now 3.0 (target R:R >= 2.0; was 1.64, now 2.14)
