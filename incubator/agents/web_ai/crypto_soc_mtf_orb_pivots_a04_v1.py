"""
crypto_soc_mtf_orb_pivots_a04_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc036MtfOrbPivotsStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2682)
        self.meanrev_w = self.p.get('meanrev_w', 0.1073)
        self.breakout_w = self.p.get('breakout_w', 0.2864)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc036MtfOrbPivotsStrategy()
    total = 0
