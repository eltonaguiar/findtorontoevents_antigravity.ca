"""
crypto_soc_delta_divergence_a04_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc034DeltaDivergenceStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2075)
        self.meanrev_w = self.p.get('meanrev_w', 0.1883)
        self.breakout_w = self.p.get('breakout_w', 0.1043)
        self.volstate_w = self.p.get('volstate_w', 0.1371)
        self.flow_w = self.p.get('flow_w', 0.3006)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc034DeltaDivergenceStrategy()
    total = 0
