"""
crypto_soc_mtf_orb_pivots_a10_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc096MtfOrbPivotsStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.3137)
        self.meanrev_w = self.p.get('meanrev_w', 0.0792)
        self.breakout_w = self.p.get('breakout_w', 0.2616)
        ...
        self.long_threshold = self.p.get('long_threshold', 0.510)
        self.short_threshold = self.p.get('short_threshold', 0.510)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc096MtfOrbPivotsStrategy()
    total = 0
