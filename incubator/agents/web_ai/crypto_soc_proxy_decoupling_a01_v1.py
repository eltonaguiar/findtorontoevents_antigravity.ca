"""
crypto_soc_proxy_decoupling_a01_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc009ProxyDecouplingStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2645)
        self.meanrev_w = self.p.get('meanrev_w', 0.1017)
        self.breakout_w = self.p.get('breakout_w', 0.1338)
        self.volstate_w = self.p.get('volstate_w', 0.2142)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc009ProxyDecouplingStrategy()
    total = 0
