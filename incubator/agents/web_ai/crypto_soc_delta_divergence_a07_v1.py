"""
crypto_soc_delta_divergence_a07_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc064DeltaDivergenceStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2322)
        self.meanrev_w = self.p.get('meanrev_w', 0.1719)
        self.breakout_w = self.p.get('breakout_w', 0.0958)
        self.volstate_w = self.p.get('volstate_w', 0.1428)
        self.flow_w = self.p.get('flow_w', 0.2994)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc064DeltaDivergenceStrategy()
    total = 0
