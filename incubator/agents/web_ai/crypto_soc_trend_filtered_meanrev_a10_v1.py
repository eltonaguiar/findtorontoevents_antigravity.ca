"""
crypto_soc_trend_filtered_meanrev_a10_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc097TrendFilteredMeanrevStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.meanrev_w = self.p.get('meanrev_w', 0.3108)
        self.breakout_w = self.p.get('breakout_w', 0.0685)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc097TrendFilteredMeanrevStrategy()
    total = 0
