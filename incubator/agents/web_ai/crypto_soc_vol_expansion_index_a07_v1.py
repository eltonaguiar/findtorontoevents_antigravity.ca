"""
crypto_soc_vol_expansion_index_a07_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc062VolExpansionIndexStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.breakout_w = self.p.get('breakout_w', 0.1749)
        self.volstate_w = self.p.get('volstate_w', 0.3009)
        self.flow_w = self.p.get('flow_w', 0.1018)
        self.session_w = self.p.get('session_w', 0.0578)

        self.long_threshold = self.p.get('long_threshold', 0.470)
        self.short_threshold = self.p.get('short_threshold', 0.470)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc062VolExpansionIndexStrategy()
    total = 0
