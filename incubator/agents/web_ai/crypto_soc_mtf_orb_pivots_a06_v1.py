"""
crypto_soc_mtf_orb_pivots_a06_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc056MtfOrbPivotsStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.2839)
        self.meanrev_w = self.p.get('meanrev_w', 0.0976)
        self.breakout_w = self.p.get('breakout_w', 0.2779)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc056MtfOrbPivotsStrategy()
    total = 0
