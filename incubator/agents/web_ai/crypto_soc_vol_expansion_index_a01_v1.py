"""
crypto_soc_vol_expansion_index_a01_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc002VolExpansionIndexStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.breakout_w = self.p.get('breakout_w', 0.1961)
        self.volstate_w = self.p.get('volstate_w', 0.2972)
        self.flow_w = self.p.get('flow_w', 0.0944)
        self.session_w = self.p.get('session_w', 0.0669)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc002VolExpansionIndexStrategy()
    total = 0
