"""
crypto_soc_dynamic_risk_heat_a08_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc080DynamicRiskHeatStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.volstate_w = self.p.get('volstate_w', 0.2034)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc080DynamicRiskHeatStrategy()
    total = 0
