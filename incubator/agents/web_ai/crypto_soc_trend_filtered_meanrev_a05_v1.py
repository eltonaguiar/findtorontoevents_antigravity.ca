"""
crypto_soc_trend_filtered_meanrev_a05_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc047TrendFilteredMeanrevStrategy:
    """Composite social-theme strategy: trend_filtered_meanrev."""

    def __init__(self, params: Optional[Dict] = None):
        self.p = params or {}
        self.fast_ema = self.p.get('fast_ema', 20)
        self.slow_ema = self.p.get('slow_ema', 64)
        self.z_window = self.p.get('z_window', 18)
        self.breakout_window = self.p.get('breakout_window', 30)
        self.vol_window = self.p.get('vol_window', 18)
        self.atr_short = self.p.get('atr_short', 9)
        self.atr_long = self.p.get('atr_long', 50)
        self.atr_gate = self.p.get('atr_gate', 1.200)
        ...
        self.trend_w = self.p.get('trend_w', 0.2560)
        self.meanrev_w = self.p.get('meanrev_w', 0.3434)
        self.breakout_w = self.p.get('breakout_w', 0.0813)
        self.volstate_w = self.p.get('volstate_w', 0.1391)
        self.flow_w = self.p.get('flow_w', 0.0994)
        self.session_w = self.p.get('session_w', 0.0808)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc047TrendFilteredMeanrevStrategy()
    total = 0
