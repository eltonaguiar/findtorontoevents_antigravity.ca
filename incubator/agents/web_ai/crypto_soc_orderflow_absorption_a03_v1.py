"""
crypto_soc_orderflow_absorption_a03_v1 - Social-Inspired High-Sharpe Baby Strat
====================================================
...
class CryptoSoc023OrderflowAbsorptionStrategy:
    ...
    def __init__(self, params: Optional[Dict] = None):
        ...
        self.trend_w = self.p.get('trend_w', 0.1786)
        self.meanrev_w = self.p.get('meanrev_w', 0.1122)
        self.breakout_w = self.p.get('breakout_w', 0.1071)
        self.volstate_w = self.p.get('volstate_w', 0.1352)
        self.flow_w = self.p.get('flow_w', 0.3827)
...
if __name__ == '__main__':
    ...
    s = CryptoSoc023OrderflowAbsorptionStrategy()
    total = 0
