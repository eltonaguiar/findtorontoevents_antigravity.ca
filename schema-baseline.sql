...
CREATE TABLE `at_audit_events` (
  ...
  `asset_class` enum('CRYPTO','FOREX','EQUITY','PENNY_STOCK','MEMECOIN','SPORTS','FUTURES','ETF','COMMODITY','BOND','UNKNOWN') COLLATE utf8mb4_unicode_ci DEFAULT 'UNKNOWN',
...
CREATE TABLE `at_consensus_picks` (
  ...
  `asset_class` enum('CRYPTO','FOREX','EQUITY','PENNY_STOCK','MEMECOIN','SPORTS','FUTURES','ETF','COMMODITY','BOND','UNKNOWN') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'UNKNOWN',
