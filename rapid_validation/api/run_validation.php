...
$DB_HOST = getenv('DB_HOST') ?: 'sql.50webs.com';
$DB_USER = getenv('DB_USER') ?: 'ejaguiar1_stocks';
$DB_PASS = getenv('DB_PASS') ?: ''; // Set via environment or hardcode
$DB_NAME = getenv('DB_NAME') ?: 'ejaguiar1_stocks';
