#!/usr/bin/env python3
"""Deploy funds.html + AUDIT_DASHBOARD_BUGS.md via FTPS to 50webs"""
import os, sys, ssl
...
print("=" * 60)
print("FUNDS PAGE DEPLOYMENT (FTPS)")
print("=" * 60)
...
try:
    ...
    if failed == 0:
        print("\nAll files deployed!")
        print("\nTest: https://findtorontoevents.ca/audit_dashboard/funds.html")
        sys.exit(0)
    else:
        sys.exit(1)
