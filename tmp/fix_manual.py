...
# Find function start (line 3511, index 3510) and end (line 3635, index 3634)
# Function starts at line 3511 (0-indexed: 3510)
# Function ends at line 3635 (0-indexed: 3634) which has "}, 100);"

new_function = '''        function playMovieFromBrowse(index) {
            ...
            setTimeout(function() {
                ...
                if (iframe) {
                    ...
                    console.error('[playMovieFromBrowse] No iframe at index', index);
                }
...
# Replace lines 3510-3634 (inclusive, 0-indexed) with new function
new_lines = lines[:3510] + [new_function] + lines[3635:]
