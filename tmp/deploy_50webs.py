#!/usr/bin/env python3
"""Deploy Mercy fix to 50webs (findtorontoevents.ca) — ARCHIVED one-shot.
...
sys.exit(
    "ARCHIVED: tmp/deploy_50webs.py is disabled. The original leaked a plaintext "
...
def deploy():
    print("=" * 60)
    print("DEPLOYING MERCY FIX TO 50WEBS (findtorontoevents.ca)")
    print("=" * 60)
    
    print(f"\n[1/5] Connecting to {FTP_HOST}...")
    ftp = ftplib.FTP(FTP_HOST, timeout=30)
    ftp.login(FTP_USER, FTP_PASS)
    print("[OK] Connected to 50webs")
