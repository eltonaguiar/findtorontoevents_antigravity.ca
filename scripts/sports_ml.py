# sports_ml.py - ML models for sports betting (OFFLINE / EXPERIMENTAL ONLY).
# Production EV, auto-place, and dashboard metrics come from PHP (sports_bets.php, sports_picks.php).
# Do not wire this script into GitHub Actions or paper placement until features match DB columns and walk-forward validation exists.
...
def fetch_historical_bets():
    ...
    WHERE result IN ('won', 'lost', 'win', 'loss')
    """
