...
Generated: 2026-05-24T21:01:12.825380+00:00

## Topline
- Open positions: 159
- Price coverage: 87.42%
- Open average PnL: 15.3657%
- Directional correctness: 43.17%
- Regime: CHOPPY

## Alerts
- [CRITICAL] PORTFOLIO_DRAWDOWN_BREACH: Paper portfolio derivatives hit 10.15% drawdown
- [HIGH] PEER_STALE: alpha_engine data is stale (85487.2m old)
- [HIGH] PEER_STALE: copy_trader_intel data is stale (219.2m old)
- [HIGH] PEER_STALE: paper_trading data is stale (113780.3m old)
- [HIGH] STRATEGY_DECAY: cta_commodity_momentum_term is a rehabilitation candidate (WR 0.0%, PF 0.0, Sharpe -140.452)
- [MEDIUM] PEER_DIRECTION_CONFLICT: Peer systems disagree on XRPUSDT ({'LONG': 4, 'SHORT': 5})
