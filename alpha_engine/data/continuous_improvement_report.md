...
Generated: 2026-05-24T23:01:33.355491+00:00

## Topline
- Open positions: 156
- Price coverage: 89.74%
- Open average PnL: 20.1151%
- Directional correctness: 64.29%
- Regime: CHOPPY

## Alerts
- [CRITICAL] PORTFOLIO_DRAWDOWN_BREACH: Paper portfolio derivatives hit 10.15% drawdown
- [HIGH] CONFIDENCE_INVERSION: High-confidence picks are underperforming low-confidence picks (52.9% vs 79.7%)
- [HIGH] PEER_STALE: alpha_engine data is stale (85607.5m old)
- [HIGH] PEER_STALE: paper_trading data is stale (113900.6m old)
- [HIGH] STRATEGY_DECAY: cta_commodity_momentum_term is a rehabilitation candidate (WR 0.0%, PF 0.0, Sharpe -143.145)
- [MEDIUM] PEER_DIRECTION_CONFLICT: Peer systems disagree on ADAUSDT ({'SHORT': 4, 'LONG': 3})
