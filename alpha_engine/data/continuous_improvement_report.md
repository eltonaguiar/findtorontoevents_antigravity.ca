...
Generated: 2026-05-23T16:05:42.807917+00:00

## Topline
- Open positions: 97
- Price coverage: 100.0%
- Open average PnL: 88.8991%
- Directional correctness: 72.16%
- Regime: BEARISH

## Alerts
- [CRITICAL] PORTFOLIO_DRAWDOWN_BREACH: Paper portfolio derivatives hit 10.15% drawdown
- [HIGH] CONFIDENCE_INVERSION: High-confidence picks are underperforming low-confidence picks (66.7% vs 90.5%)
- [HIGH] PEER_STALE: alpha_engine data is stale (83751.7m old)
- [HIGH] PEER_STALE: copy_trader_intel data is stale (158.2m old)
- [HIGH] PEER_STALE: paper_trading data is stale (112044.8m old)
- [HIGH] STRATEGY_DECAY: regime_mild_bear is a rehabilitation candidate (WR 0.0%, PF 0.0, Sharpe -79.373)
