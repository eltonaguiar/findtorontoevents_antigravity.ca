...
**Also deployed:** diversified BETA portfolio (`tools/beta_portfolio_tracker.py`, real ETF sleeves SPY/DBC/AGG/GLD/BTC, inverse-vol + light crash guard) — the honest floor (beta, not alpha). Fabricated copytrader/ML WRs being purged from elite_scorer (copy_hl done; ML strategies under audit 2026-07-04).
