"""Deploy Opportunity Scanner API + frontend to FTP production."""
import ftplib
import ssl
import os
import sys
...
FILES = [
    # Backend API
    ("live-monitor/api/opportunity_scanner.php", "live-monitor/api/opportunity_scanner.php"),
    # Frontend dashboard
    ("live-monitor/opportunity-scanner.html", "live-monitor/opportunity-scanner.html"),
    # Updated live-monitor with cross-link
...
def main():
    ...
    if errors:
        ...
        print("\nVerify:")
        print("  API:   https://findtorontoevents.ca/live-monitor/api/opportunity_scanner.php?action=opportunities")
        print("  Page:  https://findtorontoevents.ca/live-monitor/opportunity-scanner.html")
        print("\nTo run a scan (admin):")
        print("  https://findtorontoevents.ca/live-monitor/api/opportunity_scanner.php?action=scan&key=livetrader2026")
