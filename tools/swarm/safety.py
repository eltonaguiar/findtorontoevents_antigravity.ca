...
ENGINE_REQUIRED_KEYS: dict[str, tuple[str, ...]] = {
    "deepseek": ("DEEPSEEK_API", "DEEPSEEK_API_KEY", "DEEPSEEK_API_KEY_PAID", "DEEPSEEK_MODEL"),
    "cerebras": (
        "CEREBRAS_API_KEY_PAID", "CEREBRAS_API_KEY_FREE",
        "CEREBRAS_API", "CEREBRAS_API_KEY", "CERBRAS_FREE_ITHINK",
        "CEREBRAS_MODEL",
    ),
    "xai": ("X_AI_KEY", "XAI_API_KEY", "X_AI", "GROK_SUPER", "GROK_API_KEY", "GROK_API_KEY_PAID", "XAI_MODEL"),
    "inception": ("INCEPTION_AI_KEY", "INCEPTION_API_KEY", "INCEPTION_API_KEY_PAID", "INCEPTION_MODEL", "INCEPTION_API_URL"),
    ...
    "openrouter": ("OPENROUTER_API_KEY", "OPENROUTER", "OPENROUTER_API_KEY_PAID", "OPENROUTER_API_KEY_ALT", "OPENROUTER_MODEL"),
    # Groq — LPU inference, free tier available. Key envs checked in priority order.
    "groq": ("GROQ_KEY", "GROQ_API_KEY", "GROQ_API_KEY_PAID", "GROQ_MODEL"),
    # HuggingFace router — Inference Providers gateway.
    "huggingface": ("HUGGINGFACE_API", "HF_TOKEN", "HUGGINGFACE_API_KEY", "HUGGINGFACE_API_KEY_PAID", "HUGGING_FACE_TOKEN"),
    # Nous Research Portal — Hermes 4 family inference.
    "nous": ("NOUS_API_KEY", "NOUS_PORTAL_KEY", "NOUS_API_KEY_PAID", "NOUS_MODEL"),
    # Google AI Studio (Gemini) — OpenAI-compatible endpoint.
    "gemini_api": ("GEMINI_API_KEY", "GOOGLE_API_KEY", "GEMINI_API_KEY_PAID", "GEMINI_MODEL"),
    # GitHub Models — free inference for GitHub users.
    "github_models": ("GITHUB_TOKEN", "GH_TOKEN", "GITHUB_TOKEN_PAID"),
    ...
    "claude": (),
    "gemini": (),
    "opencode": ("OPENCODE_API_KEY", "OPENCODE_FREE_TIER"),
    "kilo": (),
    "copilot": ("GITHUB_COPILOT_API_KEY", "X_GITHUB_COPILOT", "COPILOT_API_KEY", "COPILOT_API_TOKEN"),
    ...
    "openclaude": (
        "OPENAI_API_KEY", "ANTHROPIC_API_KEY", "ANTHROPIC_API_KEY_PAID", "ANTR",
        "DEEPSEEK_API_KEY", "DEEPSEEK_API", "GEMINI_API_KEY", "GOOGLE_API_KEY",
    ...
    # freebuff (TUI-only PTY engine) — REMOVED 2026-05-04.
}
