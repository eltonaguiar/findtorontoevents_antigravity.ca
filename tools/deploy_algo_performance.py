#!/usr/bin/env python3
"""Deploy algorithm performance tracking system."""
import os, sys
...
FILES = [
    'live-monitor/api/algo_performance_schema.php',
    'live-monitor/api/algo_performance.php',
    'live-monitor/api/live_signals.php',
    'live-monitor/algo-performance.html',
