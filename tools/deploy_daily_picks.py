"""Deploy daily picks API + Discord bot updates + AI chatbot to FTP production."""
import ftplib
import ssl
import os
import sys
...
FILES = [
    # New API
    ("live-monitor/api/daily_picks.php", "live-monitor/api/daily_picks.php"),
    # Updated Discord bot
...
def main():
    ...
    if errors:
        ...
        print("\nVerify APIs:")
        print("  https://findtorontoevents.ca/live-monitor/api/daily_picks.php?action=crypto")
        print("  https://findtorontoevents.ca/live-monitor/api/daily_picks.php?action=forex")
        print("  https://findtorontoevents.ca/live-monitor/api/daily_picks.php?action=momentum")
        print("  https://findtorontoevents.ca/live-monitor/api/daily_picks.php?action=wins")
        print("  https://findtorontoevents.ca/live-monitor/api/daily_picks.php?action=all")
        print("\nRegister Discord commands:")
        print("  https://findtorontoevents.ca/fc/api/discord_register_commands.php")
        print("\nTest chatbot:")
        print("  Visit https://findtorontoevents.ca/ -> click robot icon -> type 'crypto picks'")
