#!/usr/bin/env python3
"""Deploy Consensus Performance Tracking files to FTP server."""
import os, sys
...
FILES = [
    # New API + schema
    ('findstocks/portfolio2/api/consensus_performance.php',        '/findstocks/portfolio2/api/consensus_performance.php'),
    ('findstocks/portfolio2/api/consensus_performance_schema.php', '/findstocks/portfolio2/api/consensus_performance_schema.php'),
    # Updated frontend
    ('findstocks/portfolio2/consolidated.html',                    '/findstocks/portfolio2/consolidated.html'),
    # Updated workflow
    ('.github/workflows/refresh-stocks-portfolio.yml',             '/.github/workflows/refresh-stocks-portfolio.yml'),
]
