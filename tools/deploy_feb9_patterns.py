"""Deploy Feb 9 batch: miracle v3 orchestrator, winning patterns API+dashboard, updated workflows."""
import ftplib
import ssl
import os
import sys
...
FILES = [
    # Miracle v3 orchestrator
    ("findstocks_global/api/daily_scan3.php", "findstocks_global/api/daily_scan3.php"),
    # Live monitor winning patterns
    ("live-monitor/api/winning_patterns.php", "live-monitor/api/winning_patterns.php"),
    ("live-monitor/winning-patterns.html", "live-monitor/winning-patterns.html"),
    # Updated live-monitor header links
