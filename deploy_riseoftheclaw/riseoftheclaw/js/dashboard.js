...
function showAlgorithmDetails(algoId) {
    ...
    document.getElementById('modalBody').innerHTML = `
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px; margin-bottom: 24px;">
            ...
            <div style="background: rgba(18, 18, 42, 0.5); padding: 16px; border-radius: 12px;">
                <div style="font-size: 12px; color: #8888aa; text-transform: uppercase;">Sharpe Ratio</div>
                <div style="font-size: 24px; font-weight: 700;">${algo.sharpeRatio.toFixed(2)}</div>
            </div>
        </div>
        ...
        <div style="margin-bottom: 16px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px;">
                <div style="text-align: center; padding: 12px; background: rgba(18, 18, 42, 0.3); border-radius: 8px;">
                    <div style="font-size: 20px; font-weight: 700;">${algo.activePicks}</div>
                    <div style="font-size: 11px; color: #8888aa;">Active Picks</div>
                </div>
                <div style="text-align: center; padding: 12px; background: rgba(18, 18, 42, 0.3); border-radius: 8px;">
                ...
                <div style="text-align: center; padding: 12px; background: rgba(18, 18, 42, 0.3); border-radius: 8px;">
                    <div style="font-size: 20px; font-weight: 700;">$${algo.startingValue.toLocaleString()}</div>
                    <div style="font-size: 11px; color: #8888aa;">Starting Value</div>
                </div>
            </div>
        </div>
        
        <div style="font-size: 14px; font-weight: 600; margin-bottom: 12px;">Category</div>
