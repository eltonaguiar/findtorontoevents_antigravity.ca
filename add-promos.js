        ...
        <div class="jsx-1b9a23bd3fa6c640 favcreators-promo" style="display: block !important; visibility: visible !important;">
          <div class="jsx-1b9a23bd3fa6c640 promo-banner" style="display: block !important; visibility: visible !important;">
            <div class="jsx-1b9a23bd3fa6c640 flex items-center gap-3 transition-all duration-500 opacity-60 grayscale hover:opacity-100 hover:grayscale-0 group" style="display: flex !important; visibility: visible !important;">
              ...
              <div class="jsx-1b9a23bd3fa6c640 relative" style="position: relative;">
                ...
                <div class="jsx-1b9a23bd3fa6c640 absolute right-0 mt-2 w-64 bg-[var(--surface-1)] border border-white/10 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300" style="padding: 12px; z-index: 100; top: 100%; max-height: 200px; overflow: visible;">
                  <p class="text-xs text-[var(--text-2)] mb-2" style="line-height: 1.4; margin: 0;">Track your favorite creators across TikTok, Twitch, Kick and YouTube!</p>
