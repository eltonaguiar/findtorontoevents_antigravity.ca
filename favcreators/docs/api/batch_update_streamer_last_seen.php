...
try {
    ...
    // Prune old log entries (keep last 7 days only) — prevents unbounded growth
    $conn->query("DELETE FROM streamer_check_log WHERE checked_at < DATE_SUB(NOW(), INTERVAL 7 DAY)");
