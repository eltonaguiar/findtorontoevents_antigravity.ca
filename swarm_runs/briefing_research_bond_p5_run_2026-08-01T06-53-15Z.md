...
You are one of 3 AI engines voting on the BOND research run at run_2026-08-01T06-53-15Z.
...
### `bond_inflation_rotation_v1` (cerebras)
  ...
  - P3: PF=1.65 WR=42.9% MDD=5.5% Sharpe=0.32 n=14
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `bond_macro_factor_duration_v1` (deepseek)
  ...
  - P3: PF=0.97 WR=68.8% MDD=12.2% Sharpe=-0.0 n=16
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "BOND",
  "run_id": "run_2026-08-01T06-53-15Z",
  "synthesis": [
    {
