...
You are one of 3 AI engines voting on the EQUITY research run at run_2026-05-16T06-51-22Z.
...
### `equity_ts_momentum_v1` (cerebras)
  ...
  - P3: PF=2.7 WR=47.1% MDD=20.6% Sharpe=0.8 n=17
...
### `equity_vol_target_v1` (cerebras)
  ...
  - P3: PF=53.95 WR=100.0% MDD=18.8% Sharpe=0.88 n=4
...
### `equity_carry_pair_v1` (cerebras)
  ...
  - P3: PF=4.44 WR=66.7% MDD=19.3% Sharpe=0.79 n=6
...
### `equity_hmm_momentum_v1` (cerebras)
  ...
  - P3: PF=4.13 WR=52.4% MDD=14.1% Sharpe=0.85 n=21
  - P4: INDEPENDENT (max|ρ|=-0.95 vs ai_challenge_scanner)
...
### `equity_bab_pair_v1` (cerebras)
  ...
  - P3: PF=4.28 WR=85.7% MDD=25.4% Sharpe=0.7 n=7
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "EQUITY",
  "run_id": "run_2026-05-16T06-51-22Z",
  "synthesis": [
    {
