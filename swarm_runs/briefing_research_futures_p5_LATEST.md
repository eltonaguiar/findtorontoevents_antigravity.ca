...
You are one of 3 AI engines voting on the FUTURES research run at run_2026-05-16T06-52-05Z.
...
### `futures_momentum_v1` (cerebras)
  ...
  - P3: PF=2.88 WR=30.0% MDD=33.5% Sharpe=0.39 n=10
  - P4: INDEPENDENT (max|ρ|=-0.93 vs mega_mutation)
  - notes: v3a REAL — yfinance prices for DBC (1256 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `futures_carry_v1` (cerebras)
  ...
  - P3: PF=2.88 WR=30.0% MDD=33.5% Sharpe=0.39 n=10
  - P4: INDEPENDENT (max|ρ|=0.94 vs contrarian_consensus)
  - notes: v3a REAL — yfinance prices for DBC (1256 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `futures_regime_switch_v1` (cerebras)
  ...
  - P3: PF=1.37 WR=21.6% MDD=42.6% Sharpe=0.23 n=37
  - P4: INDEPENDENT (max|ρ|=-0.94 vs ensemble_evolver)
  - notes: v3a REAL — yfinance prices for DBC (1256 bars). Signal: momentum (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `futures_vol_target_momentum_v1` (cerebras)
  ...
  - P3: PF=2.88 WR=30.0% MDD=33.5% Sharpe=0.39 n=10
  - P4: INDEPENDENT (max|ρ|=-0.95 vs hyperparam_dna)
  - notes: v3a REAL — yfinance prices for DBC (1256 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `futures_pair_trend_v1` (cerebras)
  ...
  - P3: PF=1.37 WR=21.6% MDD=42.6% Sharpe=0.23 n=37
  - P4: INDEPENDENT (max|ρ|=-0.93 vs predictions)
  - notes: v3a REAL — yfinance prices for DBC (1256 bars). Signal: momentum (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `futures_carry_vol_dbc_v1` (xai)
  ...
  - P3: PF=1.37 WR=21.6% MDD=42.6% Sharpe=0.23 n=37
  - P4: INDEPENDENT (max|ρ|=-0.94 vs copy_trader_variations)
  - notes: v3a REAL — yfinance prices for DBC (1256 bars). Signal: momentum (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `futures_momentum_pdbc_v1` (xai)
  ...
  - P3: PF=1.29 WR=34.0% MDD=42.0% Sharpe=0.23 n=47
  - P4: INDEPENDENT (max|ρ|=-0.94 vs incubator_battleground)
  - notes: v3a REAL — yfinance prices for PDBC (1256 bars). Signal: momentum (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `futures_regime_dba_v1` (xai)
  ...
  - P3: PF=1.77 WR=40.9% MDD=19.0% Sharpe=0.48 n=44
  - P4: INDEPENDENT (max|ρ|=-0.94 vs orphan_emitter_bond)
  - notes: v3a REAL — yfinance prices for DBA (1256 bars). Signal: momentum (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `futures_vol_target_uso_v1` (xai)
  ...
  - P3: PF=1.61 WR=35.0% MDD=59.9% Sharpe=0.33 n=40
  - P4: INDEPENDENT (max|ρ|=0.94 vs signal_aggregator)
  - notes: v3a REAL — yfinance prices for USO (1256 bars). Signal: momentum (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `futures_diagnostic_noedge_gsg_v1` (xai)
  ...
  - P3: PF=1.73 WR=43.6% MDD=34.4% Sharpe=0.43 n=39
  - P4: INDEPENDENT (max|ρ|=0.95 vs hyperparam_dna)
  - notes: v3a REAL — yfinance prices for GSG (1256 bars). Signal: momentum (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FUTURES",
  "run_id": "run_2026-05-16T06-52-05Z",
  "synthesis": [
    {
