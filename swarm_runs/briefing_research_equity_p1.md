# EQUITY research P1 — LITERATURE swarm briefing

You are one of 3 AI engines running P1 of the EQUITY research pipeline.

## Current state
EQUITY currently PF 1.41 / WR 52.7% / n=421 (Tier-2 candidate). Lift PF + n.

## Universe constraint
We trade ETF-style instruments via yfinance: `['SPY', 'QQQ', 'IWM', 'VTI', 'VOO', 'DIA', 'MDY']`. No single-ticker exotic strategies needing futures contracts, swaps, or OTC instruments.

## Your mandate
Return ≥10 citations on EQUITY trading strategies that:
