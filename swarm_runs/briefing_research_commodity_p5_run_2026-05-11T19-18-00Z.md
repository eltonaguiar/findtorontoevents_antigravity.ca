...
You are one of 3 AI engines voting on the COMMODITY research run at run_2026-05-11T19-18-00Z.
...
### `commodity_ts_momentum_gold_v1` (cerebras)
  ...
  - P3: PF=10.68 WR=25.0% MDD=20.3% Sharpe=0.96 n=4
  - P4: INDEPENDENT (max|ρ|=0.95 vs contrarian_consensus)
  - notes: v2 REAL — yfinance prices for GLD (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `commodity_energy_momentum_carry_v1` (cerebras)
  ...
  - P3: PF=2.25 WR=58.3% MDD=24.9% Sharpe=0.36 n=12
  - P4: INDEPENDENT (max|ρ|=-0.95 vs pm_whale_signals)
  - notes: v2 REAL — yfinance prices for CPER (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet p
...
```json
{
  ...
  "run_id": "run_2026-05-11T19-18-00Z",
  "synthesis": [
    {
