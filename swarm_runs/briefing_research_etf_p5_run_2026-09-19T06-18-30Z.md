...
You are one of 3 AI engines voting on the ETF research run at run_2026-09-19T06-18-30Z.
...
### `etf_carry_yield_v1` (cerebras)
  ...
  - P3: PF=82.03 WR=80.0% MDD=17.0% Sharpe=0.99 n=5
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "ETF",
  "run_id": "run_2026-09-19T06-18-30Z",
  "synthesis": [
    {
