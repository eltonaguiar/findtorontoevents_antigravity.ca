...
You are one of 3 AI engines voting on the FOREX research run at run_2026-07-04T07-04-03Z.
...
### `forex_momentum_uup_v1` (cerebras)
  ...
  - P3: PF=1.35 WR=42.3% MDD=14.4% Sharpe=0.37 n=52
...
### `forex_value_momentum_combo_fxA_v1` (cerebras)
  ...
  - P3: PF=0.59 WR=27.8% MDD=21.6% Sharpe=-0.37 n=36
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FOREX",
  "run_id": "run_2026-07-04T07-04-03Z",
  "synthesis": [
    {
