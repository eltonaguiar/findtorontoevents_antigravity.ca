# COMMODITY research P1 — LITERATURE swarm briefing

You are one of 3 AI engines running P1 of the COMMODITY research pipeline.

## Current state
COMMODITY PF 1.78 / WR 46.9% / n=750 (meets T2 PF; lift WR).

## Universe constraint
We trade ETF-style instruments via yfinance: `['GLD', 'SLV', 'PPLT', 'PALL', 'CPER', 'DBA']`. No single-ticker exotic strategies needing futures contracts, swaps, or OTC instruments.

## Your mandate
Return ≥10 citations on COMMODITY trading strategies that:
