...
You are one of 3 AI engines voting on the BOND research run at run_2026-07-18T06-42-09Z.
...
### `bond_credit_spread_term_v1` (cerebras)
  ...
  - P3: PF=1.09 WR=36.4% MDD=7.9% Sharpe=0.05 n=11
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `bond_inflation_rotation_v1` (cerebras)
  ...
  - P3: PF=1.77 WR=42.9% MDD=5.5% Sharpe=0.35 n=14
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `bond_macro_factor_duration_v1` (deepseek)
  ...
  - P3: PF=0.99 WR=73.3% MDD=12.2% Sharpe=0.0 n=15
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "BOND",
  "run_id": "run_2026-07-18T06-42-09Z",
  "synthesis": [
    {
