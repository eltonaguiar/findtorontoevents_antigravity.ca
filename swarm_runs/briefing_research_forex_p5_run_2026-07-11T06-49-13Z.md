...
You are one of 3 AI engines voting on the FOREX research run at run_2026-07-11T06-49-13Z.
...
### `forex_momentum_uup_v1` (cerebras)
  ...
  - P3: PF=1.38 WR=43.4% MDD=14.4% Sharpe=0.39 n=53
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FOREX",
  "run_id": "run_2026-07-11T06-49-13Z",
  "synthesis": [
    {
