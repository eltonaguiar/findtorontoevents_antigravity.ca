...
You are one of 3 AI engines voting on the ETF research run at run_2026-09-05T06-17-38Z.
...
### `etf_carry_yield_v1` (cerebras)
  ...
  - P3: PF=80.92 WR=75.0% MDD=17.0% Sharpe=0.98 n=4
...
### `etf_spread_arbitrage_v1` (cerebras)
  ...
  - P3: PF=2.24 WR=66.7% MDD=19.7% Sharpe=0.52 n=12
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "ETF",
  "run_id": "run_2026-09-05T06-17-38Z",
  "synthesis": [
    {
