...
You are one of 3 AI engines voting on the FOREX research run at run_2026-05-30T07-05-34Z.
...
### `forex_momentum_uup_v1` (cerebras)
  ...
  - P3: PF=1.33 WR=38.5% MDD=14.4% Sharpe=0.35 n=52
...
### `forex_value_momentum_combo_fxA_v1` (cerebras)
  ...
  - P3: PF=0.72 WR=29.4% MDD=21.6% Sharpe=-0.23 n=34
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FOREX",
  "run_id": "run_2026-05-30T07-05-34Z",
  "synthesis": [
    {
