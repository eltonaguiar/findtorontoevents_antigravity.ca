...
You are one of 3 AI engines voting on the FOREX research run at run_2026-06-20T07-24-59Z.
...
### `forex_momentum_uup_v1` (cerebras)
  ...
  - P3: PF=1.41 WR=44.2% MDD=14.4% Sharpe=0.42 n=52
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
  - notes: v3a REAL — yfinance prices for UUP (1254 bars). Signal: momentum (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `forex_value_momentum_combo_fxA_v1` (cerebras)
  ...
  - P3: PF=0.63 WR=27.8% MDD=21.6% Sharpe=-0.31 n=36
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
  - notes: v3a REAL — yfinance prices for FXA (1254 bars). Signal: momentum (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FOREX",
  "run_id": "run_2026-06-20T07-24-59Z",
  "synthesis": [
    {
