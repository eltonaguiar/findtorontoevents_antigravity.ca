...
You are one of 3 AI engines voting on the BOND research run at run_2026-08-22T06-09-09Z.
...
### `bond_inflation_rotation_v1` (cerebras)
  ...
  - P3: PF=1.7 WR=42.9% MDD=5.5% Sharpe=0.33 n=14
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "BOND",
  "run_id": "run_2026-08-22T06-09-09Z",
  "synthesis": [
    {
