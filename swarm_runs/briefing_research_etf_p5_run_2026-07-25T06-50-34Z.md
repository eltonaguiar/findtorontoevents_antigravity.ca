...
You are one of 3 AI engines voting on the ETF research run at run_2026-07-25T06-50-34Z.
...
### `etf_carry_yield_v1` (cerebras)
  ...
  - P3: PF=75.69 WR=75.0% MDD=17.0% Sharpe=0.96 n=4
...
### `etf_spread_arbitrage_v1` (cerebras)
  ...
  - P3: PF=2.1 WR=66.7% MDD=19.7% Sharpe=0.46 n=12
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "ETF",
  "run_id": "run_2026-07-25T06-50-34Z",
  "synthesis": [
    {
