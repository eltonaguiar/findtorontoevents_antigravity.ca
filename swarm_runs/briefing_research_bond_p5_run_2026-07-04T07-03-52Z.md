...
You are one of 3 AI engines voting on the BOND research run at run_2026-07-04T07-03-52Z.
...
### `bond_credit_spread_term_v1` (cerebras)
  ...
  - P3: PF=1.27 WR=40.0% MDD=7.9% Sharpe=0.1 n=10
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `bond_inflation_rotation_v1` (cerebras)
  ...
  - P3: PF=1.59 WR=35.7% MDD=5.5% Sharpe=0.28 n=14
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "BOND",
  "run_id": "run_2026-07-04T07-03-52Z",
  "synthesis": [
    {
