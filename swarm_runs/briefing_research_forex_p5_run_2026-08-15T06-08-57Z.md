...
You are one of 3 AI engines voting on the FOREX research run at run_2026-08-15T06-08-57Z.
...
### `forex_momentum_uup_v1` (cerebras)
  ...
  - P3: PF=1.34 WR=40.7% MDD=14.4% Sharpe=0.36 n=54
...
### `forex_value_momentum_combo_fxA_v1` (cerebras)
  ...
  - P3: PF=0.56 WR=25.7% MDD=21.6% Sharpe=-0.39 n=35
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
  - notes: v3a REAL — yfinance prices for FXA (1252 bars). Signal: momentum (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FOREX",
  "run_id": "run_2026-08-15T06-08-57Z",
  "synthesis": [
    {
