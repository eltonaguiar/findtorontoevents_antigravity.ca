...
You are one of 3 AI engines voting on the FOREX research run at run_2026-09-12T06-17-07Z.
...
### `forex_momentum_uup_v1` (cerebras)
  ...
  - P3: PF=1.25 WR=38.2% MDD=14.4% Sharpe=0.27 n=55
...
### `forex_value_momentum_combo_fxA_v1` (cerebras)
  ...
  - P3: PF=0.59 WR=27.8% MDD=21.6% Sharpe=-0.34 n=36
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FOREX",
  "run_id": "run_2026-09-12T06-17-07Z",
  "synthesis": [
    {
