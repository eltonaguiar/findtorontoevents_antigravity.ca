...
You are one of 3 AI engines voting on the EQUITY research run at run_2026-05-11T19-17-46Z.
...
### `equity_ts_momentum_v1` (cerebras)
  ...
  - P3: PF=55.79 WR=100.0% MDD=18.8% Sharpe=0.91 n=4
  - P4: INDEPENDENT (max|ρ|=0.95 vs ai_challenge_scanner)
  - notes: v2 REAL — yfinance prices for SPY (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `equity_carry_pair_v1` (cerebras)
  ...
  - P3: PF=5.24 WR=66.7% MDD=19.3% Sharpe=0.83 n=6
  - P4: INDEPENDENT (max|ρ|=0.95 vs live_position_monitor)
  - notes: v2 REAL — yfinance prices for VTI (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `equity_hmm_momentum_v1` (cerebras)
  ...
  - P3: PF=100.64 WR=100.0% MDD=22.8% Sharpe=1.16 n=3
  - P4: INDEPENDENT (max|ρ|=-0.95 vs ai_challenge_scanner)
  - notes: v2 REAL — yfinance prices for QQQ (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `equity_bab_pair_v1` (cerebras)
  ...
  - P3: PF=5.24 WR=66.7% MDD=19.3% Sharpe=0.83 n=6
  - P4: INDEPENDENT (max|ρ|=0.94 vs genetic_programmer)
  - notes: v2 REAL — yfinance prices for VTI (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "EQUITY",
  "run_id": "run_2026-05-11T19-17-46Z",
  "synthesis": [
    {
