...
You are one of 3 AI engines voting on the ETF research run at run_2026-06-20T07-25-22Z.
...
### `etf_carry_yield_v1` (cerebras)
  ...
  - P3: PF=83.25 WR=75.0% MDD=17.0% Sharpe=1.06 n=4
...
### `etf_spread_arbitrage_v1` (cerebras)
  ...
  - P3: PF=1.99 WR=61.5% MDD=19.7% Sharpe=0.45 n=13
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "ETF",
  "run_id": "run_2026-06-20T07-25-22Z",
  "synthesis": [
    {
