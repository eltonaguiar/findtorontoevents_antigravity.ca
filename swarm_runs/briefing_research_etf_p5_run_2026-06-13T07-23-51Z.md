...
You are one of 3 AI engines voting on the ETF research run at run_2026-06-13T07-23-51Z.
...
### `etf_carry_yield_v1` (cerebras)
  ...
  - P3: PF=79.32 WR=75.0% MDD=17.0% Sharpe=1.03 n=4
...
### `etf_spread_arbitrage_v1` (cerebras)
  ...
  - P3: PF=1.79 WR=61.5% MDD=19.7% Sharpe=0.39 n=13
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "ETF",
  "run_id": "run_2026-06-13T07-23-51Z",
  "synthesis": [
    {
