...
You are one of 3 AI engines voting on the FOREX research run at run_2026-08-22T06-09-17Z.
...
### `forex_momentum_uup_v1` (cerebras)
  ...
  - P3: PF=1.25 WR=38.9% MDD=14.4% Sharpe=0.27 n=54
...
### `forex_value_momentum_combo_fxA_v1` (cerebras)
  ...
  - P3: PF=0.58 WR=27.0% MDD=21.6% Sharpe=-0.35 n=37
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FOREX",
  "run_id": "run_2026-08-22T06-09-17Z",
  "synthesis": [
    {
