...
You are one of 3 AI engines voting on the COMMODITY research run at run_2026-08-08T06-17-52Z.
...
### `commodity_ts_momentum_gold_v1` (cerebras)
  ...
  - P3: PF=11.64 WR=66.7% MDD=18.5% Sharpe=1.09 n=15
...
### `commodity_carry_value_gold_silver_v1` (cerebras)
  ...
  - P3: PF=10.22 WR=25.0% MDD=26.2% Sharpe=0.79 n=4
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `commodity_energy_momentum_carry_v1` (cerebras)
  ...
  - P3: PF=2.7 WR=63.6% MDD=24.8% Sharpe=0.41 n=11
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `commodity_value_agriculture_v1` (deepseek)
  ...
  - P3: PF=2.14 WR=61.1% MDD=14.0% Sharpe=0.49 n=18
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "run_id": "run_2026-08-08T06-17-52Z",
  "synthesis": [
    {
