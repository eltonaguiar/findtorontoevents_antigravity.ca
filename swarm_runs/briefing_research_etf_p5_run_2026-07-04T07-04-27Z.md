...
You are one of 3 AI engines voting on the ETF research run at run_2026-07-04T07-04-27Z.
...
### `etf_carry_yield_v1` (cerebras)
  ...
  - P3: PF=76.96 WR=75.0% MDD=17.0% Sharpe=0.98 n=4
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
  - notes: v3a REAL — yfinance prices for XLK (1254 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `etf_spread_arbitrage_v1` (cerebras)
  ...
  - P3: PF=2.11 WR=66.7% MDD=19.7% Sharpe=0.47 n=12
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
  - notes: v3a REAL — yfinance prices for XLF (1254 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "ETF",
  "run_id": "run_2026-07-04T07-04-27Z",
  "synthesis": [
    {
