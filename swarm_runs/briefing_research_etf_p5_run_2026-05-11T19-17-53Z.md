...
You are one of 3 AI engines voting on the ETF research run at run_2026-05-11T19-17-53Z.
...
### `etf_carry_yield_v1` (cerebras)
  ...
  - P3: PF=77.12 WR=80.0% MDD=17.0% Sharpe=1.02 n=5
  - P4: INDEPENDENT (max|ρ|=-0.95 vs signal_aggregator)
  - notes: v2 REAL — yfinance prices for XLK (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `etf_spread_arbitrage_v1` (cerebras)
  ...
  - P3: PF=1.97 WR=61.5% MDD=19.7% Sharpe=0.43 n=13
  - P4: INDEPENDENT (max|ρ|=0.93 vs wf_audit_signals)
  - notes: v2 REAL — yfinance prices for XLF (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `etf_cross_asset_momentum_v1` (cerebras)
  ...
  - P3: PF=77.12 WR=80.0% MDD=17.0% Sharpe=1.02 n=5
  - P4: INDEPENDENT (max|ρ|=0.94 vs incubator_gainer)
  - notes: v2 REAL — yfinance prices for XLK (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `etf_value_momentum_combo_v1` (cerebras)
  ...
  - P3: PF=77.12 WR=80.0% MDD=17.0% Sharpe=1.02 n=5
  - P4: INDEPENDENT (max|ρ|=0.94 vs etf_sector_rotation)
  - notes: v2 REAL — yfinance prices for XLK (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `etf_diagnostic_momentum_v1` (cerebras)
  ...
  - P3: PF=77.12 WR=80.0% MDD=17.0% Sharpe=1.02 n=5
  - P4: INDEPENDENT (max|ρ|=0.94 vs luxalgo_filters)
  - notes: v2 REAL — yfinance prices for XLK (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "ETF",
  "run_id": "run_2026-05-11T19-17-53Z",
  "synthesis": [
    {
