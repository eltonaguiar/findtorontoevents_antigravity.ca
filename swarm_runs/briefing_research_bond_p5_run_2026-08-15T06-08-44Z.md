...
You are one of 3 AI engines voting on the BOND research run at run_2026-08-15T06-08-44Z.
...
### `bond_credit_spread_term_v1` (cerebras)
  ...
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
  - notes: v3a REAL — yfinance prices for LQD (1252 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `bond_inflation_rotation_v1` (cerebras)
  ...
  - P3: PF=1.54 WR=42.9% MDD=5.5% Sharpe=0.28 n=14
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
  - notes: v3a REAL — yfinance prices for TIP (1252 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `bond_macro_factor_duration_v1` (deepseek)
  ...
  - P3: PF=0.93 WR=73.3% MDD=12.2% Sharpe=-0.02 n=15
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `bond_momentum_cross_v1` (xai)
  ...
  - P3: PF=0.41 WR=17.9% MDD=14.4% Sharpe=-0.59 n=28
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "BOND",
  "run_id": "run_2026-08-15T06-08-44Z",
  "synthesis": [
    {
