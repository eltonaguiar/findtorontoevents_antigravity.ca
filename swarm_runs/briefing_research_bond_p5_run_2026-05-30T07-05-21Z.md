...
You are one of 3 AI engines voting on the BOND research run at run_2026-05-30T07-05-21Z.
...
### `bond_credit_spread_term_v1` (cerebras)
  ...
  - P3: PF=1.19 WR=33.3% MDD=7.9% Sharpe=0.07 n=9
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `bond_inflation_rotation_v1` (cerebras)
  ...
  - P3: PF=1.89 WR=46.2% MDD=5.5% Sharpe=0.39 n=13
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `bond_momentum_cross_v1` (xai)
  ...
  - P3: PF=0.4 WR=18.5% MDD=16.2% Sharpe=-0.62 n=27
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "BOND",
  "run_id": "run_2026-05-30T07-05-21Z",
  "synthesis": [
    {
