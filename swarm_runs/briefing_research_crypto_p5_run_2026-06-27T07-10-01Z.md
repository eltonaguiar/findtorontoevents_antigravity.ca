...
You are one of 3 AI engines voting on the CRYPTO research run at run_2026-06-27T07-10-01Z.
...
### `crypto_cross_mom_v1` (cerebras)
  ...
  - P3: PF=5.7 WR=60.0% MDD=37.1% Sharpe=0.44 n=5
...
### `crypto_ml_boost_v1` (deepseek)
  ...
  - P3: PF=22.02 WR=100.0% MDD=76.6% Sharpe=0.28 n=1
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `crypto_momentum_btc_v1` (xai)
  ...
  - P3: PF=1.82 WR=31.2% MDD=59.4% Sharpe=0.42 n=32
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `crypto_vol_target_eth_v1` (xai)
  ...
  - P3: PF=1.02 WR=60.0% MDD=61.6% Sharpe=0.06 n=5
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "CRYPTO",
  "run_id": "run_2026-06-27T07-10-01Z",
  "synthesis": [
    {
