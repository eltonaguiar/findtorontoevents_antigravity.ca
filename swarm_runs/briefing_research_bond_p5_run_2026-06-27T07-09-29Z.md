...
You are one of 3 AI engines voting on the BOND research run at run_2026-06-27T07-09-29Z.
...
### `bond_credit_spread_term_v1` (cerebras)
  ...
  - P3: PF=1.29 WR=40.0% MDD=7.9% Sharpe=0.1 n=10
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `bond_inflation_rotation_v1` (cerebras)
  ...
  - P3: PF=1.85 WR=42.9% MDD=5.5% Sharpe=0.37 n=14
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `bond_momentum_cross_v1` (xai)
  ...
  - P3: PF=0.39 WR=17.9% MDD=16.0% Sharpe=-0.64 n=28
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "BOND",
  "run_id": "run_2026-06-27T07-09-29Z",
  "synthesis": [
    {
