...
You are one of 3 AI engines voting on the FUTURES research run at run_2026-06-27T07-10-20Z.
...
### `futures_momentum_v1` (cerebras)
  ...
  - P3: PF=1.16 WR=30.0% MDD=33.5% Sharpe=0.08 n=10
...
### `futures_carry_v1` (cerebras)
  ...
  - P3: PF=1.23 WR=30.0% MDD=33.5% Sharpe=0.1 n=10
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `futures_regime_switch_v1` (cerebras)
  ...
  - P3: PF=1.26 WR=22.2% MDD=42.6% Sharpe=0.18 n=36
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `futures_momentum_pdbc_v1` (xai)
  ...
  - P3: PF=1.24 WR=34.8% MDD=42.0% Sharpe=0.2 n=46
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `futures_regime_dba_v1` (xai)
  ...
  - P3: PF=1.62 WR=43.2% MDD=19.0% Sharpe=0.42 n=44
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `futures_vol_target_uso_v1` (xai)
  ...
  - P3: PF=1.23 WR=34.2% MDD=59.9% Sharpe=0.17 n=38
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FUTURES",
  "run_id": "run_2026-06-27T07-10-20Z",
  "synthesis": [
    {
