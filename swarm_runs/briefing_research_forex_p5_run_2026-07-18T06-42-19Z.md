...
You are one of 3 AI engines voting on the FOREX research run at run_2026-07-18T06-42-19Z.
...
### `forex_momentum_uup_v1` (cerebras)
  ...
  - P3: PF=1.35 WR=41.5% MDD=14.4% Sharpe=0.37 n=53
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FOREX",
  "run_id": "run_2026-07-18T06-42-19Z",
  "synthesis": [
    {
