...
You are one of 3 AI engines voting on the FOREX research run at run_2026-05-11T19-14-54Z.
...
### `forex_momentum_uup_v1` (cerebras)
  ...
  - P3: PF=1.61 WR=56.7% MDD=11.3% Sharpe=0.46 n=30
  - P4: INDEPENDENT (max|ρ|=0.94 vs breakout_c_spike)
  - notes: v2 REAL — yfinance prices for UUP (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `forex_value_momentum_combo_fxA_v1` (cerebras)
  ...
  - P3: PF=0.7 WR=41.7% MDD=18.1% Sharpe=-0.19 n=12
  - P4: INDEPENDENT (max|ρ|=-0.95 vs ml_bg_system_a)
  - notes: v2 REAL — yfinance prices for FXA (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `forex_regime_conditional_hybrid_fxA_v1` (cerebras)
  ...
  - P3: PF=0.7 WR=41.7% MDD=18.1% Sharpe=-0.19 n=12
  - P4: INDEPENDENT (max|ρ|=0.94 vs battleground_mutations)
  - notes: v2 REAL — yfinance prices for FXA (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `forex_dollar_carry_uup_v1` (cerebras)
  ...
  - P3: PF=1.61 WR=56.7% MDD=11.3% Sharpe=0.46 n=30
  - P4: INDEPENDENT (max|ρ|=0.95 vs cta_replicator)
  - notes: v2 REAL — yfinance prices for UUP (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `forex_risk_parity_multi_etf_v1` (cerebras)
  ...
  - P3: PF=1.61 WR=56.7% MDD=11.3% Sharpe=0.46 n=30
  - P4: INDEPENDENT (max|ρ|=-0.95 vs etf_sector_rotation)
  - notes: v2 REAL — yfinance prices for UUP (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FOREX",
  "run_id": "run_2026-05-11T19-14-54Z",
  "synthesis": [
    {
