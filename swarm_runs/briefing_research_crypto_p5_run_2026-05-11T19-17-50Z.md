...
You are one of 3 AI engines voting on the CRYPTO research run at run_2026-05-11T19-17-50Z.
...
### `crypto_cross_mom_v1` (cerebras)
  ...
  - P3: PF=2.86 WR=60.0% MDD=37.1% Sharpe=0.34 n=5
  - P4: INDEPENDENT (max|ρ|=-0.94 vs orphan_emitter_forex_futures)
  - notes: v2 REAL — yfinance prices for BTC-USD (1827 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not ye
...
### `crypto_vol_target_eth_v1` (xai)
  ...
  - P3: PF=0.86 WR=60.0% MDD=61.6% Sharpe=0.0 n=5
  - P4: INDEPENDENT (max|ρ|=-0.95 vs auto_dna_mutation)
  - notes: v2 REAL — yfinance prices for ETH-USD (1827 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not ye
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "CRYPTO",
  "run_id": "run_2026-05-11T19-17-50Z",
  "synthesis": [
    {
