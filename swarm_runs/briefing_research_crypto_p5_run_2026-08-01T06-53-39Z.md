...
You are one of 3 AI engines voting on the CRYPTO research run at run_2026-08-01T06-53-39Z.
...
### `crypto_momentum_btc_v1` (xai)
  ...
  - P3: PF=2.03 WR=32.3% MDD=59.4% Sharpe=0.5 n=31
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "CRYPTO",
  "run_id": "run_2026-08-01T06-53-39Z",
  "synthesis": [
    {
