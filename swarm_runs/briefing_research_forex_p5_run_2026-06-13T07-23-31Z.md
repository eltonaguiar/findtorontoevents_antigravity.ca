...
You are one of 3 AI engines voting on the FOREX research run at run_2026-06-13T07-23-31Z.
...
### `forex_momentum_uup_v1` (cerebras)
  ...
  - P3: PF=1.37 WR=42.3% MDD=14.4% Sharpe=0.39 n=52
...
### `forex_value_momentum_combo_fxA_v1` (cerebras)
  ...
  - P3: PF=0.64 WR=28.6% MDD=21.6% Sharpe=-0.3 n=35
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FOREX",
  "run_id": "run_2026-06-13T07-23-31Z",
  "synthesis": [
    {
