...
You are one of 3 AI engines voting on the FOREX research run at run_2026-05-16T06-51-10Z.
...
### `forex_momentum_uup_v1` (cerebras)
  ...
  - P3: PF=1.34 WR=39.2% MDD=14.4% Sharpe=0.36 n=51
  - P4: INDEPENDENT (max|ρ|=0.94 vs breakout_c_spike)
  - notes: v3a REAL — yfinance prices for UUP (1256 bars). Signal: momentum (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `forex_value_momentum_combo_fxA_v1` (cerebras)
  ...
  - P3: PF=0.7 WR=29.4% MDD=21.6% Sharpe=-0.25 n=34
  - P4: INDEPENDENT (max|ρ|=-0.95 vs ml_bg_system_a)
  - notes: v3a REAL — yfinance prices for FXA (1256 bars). Signal: momentum (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FOREX",
  "run_id": "run_2026-05-16T06-51-10Z",
  "synthesis": [
    {
