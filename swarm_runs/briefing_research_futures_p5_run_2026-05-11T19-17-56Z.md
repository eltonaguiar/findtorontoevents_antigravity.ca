...
You are one of 3 AI engines voting on the FUTURES research run at run_2026-05-11T19-17-56Z.
...
### `futures_momentum_v1` (cerebras)
  ...
  - P3: PF=3.5 WR=40.0% MDD=33.5% Sharpe=0.44 n=10
  - P4: INDEPENDENT (max|ρ|=-0.93 vs mega_mutation)
  - notes: v2 REAL — yfinance prices for DBC (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `futures_momentum_pdbc_v1` (xai)
  ...
  - P3: PF=1.89 WR=46.7% MDD=35.0% Sharpe=0.4 n=15
  - P4: INDEPENDENT (max|ρ|=-0.94 vs incubator_battleground)
  - notes: v2 REAL — yfinance prices for PDBC (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet p
...
### `futures_regime_dba_v1` (xai)
  ...
  - P3: PF=2.66 WR=64.7% MDD=15.9% Sharpe=0.6 n=17
  - P4: INDEPENDENT (max|ρ|=-0.94 vs orphan_emitter_bond)
  - notes: v2 REAL — yfinance prices for DBA (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `futures_vol_target_uso_v1` (xai)
  ...
  - P3: PF=1.67 WR=14.3% MDD=54.8% Sharpe=0.2 n=7
  - P4: INDEPENDENT (max|ρ|=0.94 vs signal_aggregator)
  - notes: v2 REAL — yfinance prices for USO (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `futures_diagnostic_noedge_gsg_v1` (xai)
  ...
  - P3: PF=2.22 WR=66.7% MDD=37.4% Sharpe=0.39 n=15
  - P4: INDEPENDENT (max|ρ|=0.95 vs forex_copy_trader)
  - notes: v2 REAL — yfinance prices for GSG (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FUTURES",
  "run_id": "run_2026-05-11T19-17-56Z",
  "synthesis": [
    {
