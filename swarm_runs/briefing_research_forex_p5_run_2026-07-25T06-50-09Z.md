...
You are one of 3 AI engines voting on the FOREX research run at run_2026-07-25T06-50-09Z.
...
### `forex_value_momentum_combo_fxA_v1` (cerebras)
  ...
  - P3: PF=0.55 WR=27.8% MDD=21.6% Sharpe=-0.42 n=36
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FOREX",
  "run_id": "run_2026-07-25T06-50-09Z",
  "synthesis": [
    {
