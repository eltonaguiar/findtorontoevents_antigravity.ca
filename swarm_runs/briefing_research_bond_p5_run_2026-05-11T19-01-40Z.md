...
You are one of 3 AI engines voting on the BOND research run at run_2026-05-11T19-01-40Z.
...
### `bond_momentum_longshort_v1` (cerebras)
  ...
  - notes: v2 REAL — yfinance prices for TLT (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `bond_liquidity_spread_v1` (cerebras)
  ...
  - P3: PF=0.0 WR=0.0% MDD=12.6% Sharpe=-0.3 n=5
  - P4: INDEPENDENT (max|ρ|=-0.95 vs crypto_signal_engine)
  - notes: v2 REAL — yfinance prices for TLT (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `bond_credit_spread_term_v1` (cerebras)
  ...
  - P3: PF=1.51 WR=33.3% MDD=7.9% Sharpe=0.14 n=9
  - P4: INDEPENDENT (max|ρ|=0.95 vs auto_dna_mutation)
  - notes: v2 REAL — yfinance prices for LQD (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `bond_inflation_rotation_v1` (cerebras)
  ...
  - P3: PF=1.99 WR=45.5% MDD=5.5% Sharpe=0.4 n=11
  - P4: INDEPENDENT (max|ρ|=-0.95 vs fast_stocks_competition)
  - notes: v2 REAL — yfinance prices for TIP (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
### `bond_momentum_cross_country_v1` (deepseek)
  ...
  - P3: PF=0.94 WR=42.9% MDD=8.5% Sharpe=-0.01 n=7
  - P4: INDEPENDENT (max|ρ|=0.95 vs forex_copy_trader)
  - notes: v2 REAL — yfinance prices for IEF (1256 bars). Signal: SMA(50)/SMA(200) crossover, long-only. Simplified spec translation — spec.entry text not yet pa
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "BOND",
  "run_id": "run_2026-05-11T19-01-40Z",
  "synthesis": [
    {
