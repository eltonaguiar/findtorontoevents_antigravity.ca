...
You are one of 3 AI engines voting on the COMMODITY research run at run_2026-09-26T06-18-56Z.
...
### `commodity_ts_momentum_gold_v1` (cerebras)
  ...
  - P3: PF=8.58 WR=60.0% MDD=18.5% Sharpe=1.03 n=15
...
### `commodity_energy_momentum_carry_v1` (cerebras)
  ...
  - P3: PF=2.77 WR=60.0% MDD=24.8% Sharpe=0.42 n=10
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `commodity_value_agriculture_v1` (deepseek)
  ...
  - P3: PF=4.84 WR=72.2% MDD=12.4% Sharpe=0.78 n=18
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "run_id": "run_2026-09-26T06-18-56Z",
  "synthesis": [
    {
