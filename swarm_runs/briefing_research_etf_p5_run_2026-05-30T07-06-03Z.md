...
You are one of 3 AI engines voting on the ETF research run at run_2026-05-30T07-06-03Z.
...
### `etf_carry_yield_v1` (cerebras)
  ...
  - P3: PF=85.65 WR=80.0% MDD=17.0% Sharpe=1.13 n=5
...
### `etf_spread_arbitrage_v1` (cerebras)
  ...
  - P3: PF=2.14 WR=69.2% MDD=19.7% Sharpe=0.48 n=13
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "ETF",
  "run_id": "run_2026-05-30T07-06-03Z",
  "synthesis": [
    {
