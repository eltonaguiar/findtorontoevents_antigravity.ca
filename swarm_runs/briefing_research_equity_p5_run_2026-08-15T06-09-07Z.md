...
You are one of 3 AI engines voting on the EQUITY research run at run_2026-08-15T06-09-07Z.
...
### `equity_ts_momentum_v1` (cerebras)
  ...
  - P3: PF=2.82 WR=43.8% MDD=20.6% Sharpe=0.83 n=16
...
### `equity_vol_target_v1` (cerebras)
  ...
  - P3: PF=59.12 WR=100.0% MDD=18.8% Sharpe=0.94 n=3
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `equity_carry_pair_v1` (cerebras)
  ...
  - P3: PF=6.22 WR=80.0% MDD=19.3% Sharpe=0.93 n=5
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `equity_hmm_momentum_v1` (cerebras)
  ...
  - P3: PF=3.58 WR=52.6% MDD=14.1% Sharpe=0.74 n=19
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "EQUITY",
  "run_id": "run_2026-08-15T06-09-07Z",
  "synthesis": [
    {
