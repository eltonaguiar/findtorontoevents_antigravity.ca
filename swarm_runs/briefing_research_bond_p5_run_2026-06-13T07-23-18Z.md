...
You are one of 3 AI engines voting on the BOND research run at run_2026-06-13T07-23-18Z.
...
### `bond_credit_spread_term_v1` (cerebras)
  ...
  - P3: PF=1.23 WR=40.0% MDD=7.9% Sharpe=0.09 n=10
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `bond_inflation_rotation_v1` (cerebras)
  ...
  - P3: PF=1.85 WR=46.2% MDD=5.5% Sharpe=0.37 n=13
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `bond_macro_factor_duration_v1` (deepseek)
  ...
  - P3: PF=0.88 WR=73.3% MDD=12.2% Sharpe=-0.05 n=15
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `bond_momentum_cross_v1` (xai)
  ...
  - P3: PF=0.4 WR=18.5% MDD=16.2% Sharpe=-0.63 n=27
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "BOND",
  "run_id": "run_2026-06-13T07-23-18Z",
  "synthesis": [
    {
