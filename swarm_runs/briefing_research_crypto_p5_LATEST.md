...
You are one of 3 AI engines voting on the CRYPTO research run at run_2026-05-16T06-51-37Z.
...
### `crypto_cross_mom_v1` (cerebras)
  ...
  - P3: PF=2.49 WR=60.0% MDD=37.1% Sharpe=0.31 n=5
  - P4: INDEPENDENT (max|ρ|=-0.94 vs orphan_emitter_forex_futures)
  - notes: v3a REAL — yfinance prices for BTC-USD (1827 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `crypto_ts_mom_v1` (cerebras)
  ...
  - P3: PF=2.49 WR=60.0% MDD=37.1% Sharpe=0.31 n=5
  - P4: INDEPENDENT (max|ρ|=0.94 vs claude_gainer_st)
  - notes: v3a REAL — yfinance prices for BTC-USD (1827 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `crypto_vol_target_v1` (cerebras)
  ...
  - P3: PF=2.49 WR=60.0% MDD=37.1% Sharpe=0.31 n=5
  - P4: INDEPENDENT (max|ρ|=0.94 vs dna_confluence_mutations)
  - notes: v3a REAL — yfinance prices for BTC-USD (1827 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `crypto_regime_switch_v1` (cerebras)
  ...
  - P3: PF=2.49 WR=60.0% MDD=37.1% Sharpe=0.31 n=5
  - P4: INDEPENDENT (max|ρ|=-0.94 vs baby_strats_forward)
  - notes: v3a REAL — yfinance prices for BTC-USD (1827 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `crypto_pairs_trade_v1` (cerebras)
  ...
  - P3: PF=2.49 WR=60.0% MDD=37.1% Sharpe=0.31 n=5
  - P4: INDEPENDENT (max|ρ|=-0.95 vs incubator_gainer)
  - notes: v3a REAL — yfinance prices for BTC-USD (1827 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `crypto_vol_target_btc_v1` (deepseek)
  ...
  - P3: PF=2.49 WR=60.0% MDD=37.1% Sharpe=0.31 n=5
  - P4: INDEPENDENT (max|ρ|=0.95 vs ml_bg_system_d)
  - notes: v3a REAL — yfinance prices for BTC-USD (1827 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `crypto_ml_boost_v1` (deepseek)
  ...
  - P3: PF=86.01 WR=100.0% MDD=76.6% Sharpe=0.41 n=1
  - P4: INDEPENDENT (max|ρ|=0.94 vs ai_challenge_scanner)
  - notes: v3a REAL — yfinance prices for BTC-USD (1827 bars). Signal: breakout (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `crypto_diagnostic_noedge_v1` (deepseek)
  ...
  - P3: PF=2.49 WR=60.0% MDD=37.1% Sharpe=0.31 n=5
  - P4: INDEPENDENT (max|ρ|=-0.95 vs claude_gainer_ml_perf)
  - notes: v3a REAL — yfinance prices for BTC-USD (1827 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `crypto_momentum_btc_v1` (xai)
  ...
  - P3: PF=2.28 WR=37.5% MDD=59.4% Sharpe=0.59 n=32
  - P4: INDEPENDENT (max|ρ|=0.94 vs kimi_live_signals)
  - notes: v3a REAL — yfinance prices for BTC-USD (1827 bars). Signal: momentum (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `crypto_vol_target_eth_v1` (xai)
  ...
  - P3: PF=0.79 WR=60.0% MDD=61.6% Sharpe=-0.05 n=5
  - P4: INDEPENDENT (max|ρ|=-0.95 vs goldmine_stocks)
  - notes: v3a REAL — yfinance prices for ETH-USD (1827 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `crypto_pairs_btc_eth_v1` (xai)
  ...
  - P3: PF=2.49 WR=60.0% MDD=37.1% Sharpe=0.31 n=5
  - P4: INDEPENDENT (max|ρ|=-0.94 vs overnight_mutations)
  - notes: v3a REAL — yfinance prices for BTC-USD (1827 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `crypto_regime_switch_btc_v1` (xai)
  ...
  - P3: PF=2.49 WR=60.0% MDD=37.1% Sharpe=0.31 n=5
  - P4: INDEPENDENT (max|ρ|=0.95 vs mega_mutation)
  - notes: v3a REAL — yfinance prices for BTC-USD (1827 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "CRYPTO",
  "run_id": "run_2026-05-16T06-51-37Z",
  "synthesis": [
    {
