# FUTURES research P1 — LITERATURE swarm briefing

You are one of 3 AI engines running P1 of the FUTURES research pipeline.

## Current state
FUTURES has effectively no production picks. Greenfield exploration.

## Universe constraint
We trade ETF-style instruments via yfinance: `['DBC', 'GSG', 'DBA', 'USO', 'UNG', 'PDBC']`. No single-ticker exotic strategies needing futures contracts, swaps, or OTC instruments.

## Your mandate
Return ≥10 citations on FUTURES trading strategies that:
