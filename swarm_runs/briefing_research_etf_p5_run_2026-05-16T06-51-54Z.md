...
You are one of 3 AI engines voting on the ETF research run at run_2026-05-16T06-51-54Z.
...
### `etf_carry_yield_v1` (cerebras)
  ...
  - P3: PF=67.79 WR=60.0% MDD=17.0% Sharpe=0.98 n=5
  - P4: INDEPENDENT (max|ρ|=-0.95 vs signal_aggregator)
  - notes: v3a REAL — yfinance prices for XLK (1256 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
### `etf_spread_arbitrage_v1` (cerebras)
  ...
  - P3: PF=2.17 WR=69.2% MDD=19.7% Sharpe=0.48 n=13
  - P4: INDEPENDENT (max|ρ|=-0.95 vs commodity_carry_momo)
  - notes: v3a REAL — yfinance prices for XLF (1256 bars). Signal: sma_cross (keyword-routed from spec.entry). LLM-driven signal translation queued for v3b.
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "ETF",
  "run_id": "run_2026-05-16T06-51-54Z",
  "synthesis": [
    {
