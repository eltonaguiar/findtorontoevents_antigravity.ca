...
You are one of 3 AI engines voting on the FUTURES research run at run_2026-07-04T07-04-33Z.
...
### `futures_momentum_v1` (cerebras)
  ...
  - P3: PF=0.99 WR=30.0% MDD=33.5% Sharpe=0.01 n=10
...
### `futures_regime_switch_v1` (cerebras)
  ...
  - P3: PF=1.21 WR=22.2% MDD=42.6% Sharpe=0.14 n=36
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `futures_momentum_pdbc_v1` (xai)
  ...
  - P3: PF=1.2 WR=34.8% MDD=42.0% Sharpe=0.16 n=46
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `futures_regime_dba_v1` (xai)
  ...
  - P3: PF=1.56 WR=40.5% MDD=19.0% Sharpe=0.38 n=42
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `futures_vol_target_uso_v1` (xai)
  ...
  - P3: PF=1.2 WR=34.2% MDD=59.9% Sharpe=0.14 n=38
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `futures_diagnostic_noedge_gsg_v1` (xai)
  ...
  - P3: PF=1.58 WR=44.7% MDD=34.4% Sharpe=0.35 n=38
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "FUTURES",
  "run_id": "run_2026-07-04T07-04-33Z",
  "synthesis": [
    {
