...
You are one of 3 AI engines voting on the BOND research run at run_2026-09-26T06-18-06Z.
...
### `bond_macro_factor_duration_v1` (deepseek)
  ...
  - P3: PF=0.67 WR=66.7% MDD=12.2% Sharpe=-0.18 n=15
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `bond_momentum_cross_v1` (xai)
  ...
  - P3: PF=0.42 WR=17.9% MDD=14.4% Sharpe=-0.56 n=28
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "BOND",
  "run_id": "run_2026-09-26T06-18-06Z",
  "synthesis": [
    {
