...
You are one of 3 AI engines voting on the CRYPTO research run at run_2026-09-12T06-17-25Z.
...
### `crypto_cross_mom_v1` (cerebras)
  ...
  - P3: PF=5.83 WR=60.0% MDD=38.6% Sharpe=0.45 n=5
...
### `crypto_ml_boost_v1` (deepseek)
  ...
  - P3: PF=14.25 WR=100.0% MDD=76.6% Sharpe=0.25 n=1
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `crypto_momentum_btc_v1` (xai)
  ...
  - P3: PF=1.71 WR=30.3% MDD=58.1% Sharpe=0.39 n=33
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
### `crypto_vol_target_eth_v1` (xai)
  ...
  - P3: PF=1.67 WR=80.0% MDD=61.6% Sharpe=0.19 n=5
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "CRYPTO",
  "run_id": "run_2026-09-12T06-17-25Z",
  "synthesis": [
    {
