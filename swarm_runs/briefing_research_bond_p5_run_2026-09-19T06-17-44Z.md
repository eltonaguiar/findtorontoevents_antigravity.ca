...
You are one of 3 AI engines voting on the BOND research run at run_2026-09-19T06-17-44Z.
...
### `bond_macro_factor_duration_v1` (deepseek)
  ...
  - P3: PF=0.71 WR=66.7% MDD=12.2% Sharpe=-0.15 n=15
  - P4: INDEPENDENT (max|ρ|=0.0 vs (no shipped strategies found))
...
```json
{
  ...
  "engine": "<your name>",
  "asset_class": "BOND",
  "run_id": "run_2026-09-19T06-17-44Z",
  "synthesis": [
    {
